...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.LogApi();
  });
  ...
  describe('LogApi', function() {
    describe('cgetByOperation', function() {
      it('should call cgetByOperation successfully', function(done) {
        //uncomment below and update the code to test cgetByOperation
        //instance.cgetByOperation(function(error) {
