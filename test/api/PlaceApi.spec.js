...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PlaceApi();
  });
  ...
  describe('PlaceApi', function() {
    describe('organizationsOrganizationPlacesGet', function() {
      it('should call organizationsOrganizationPlacesGet successfully', function(done) {
        //uncomment below and update the code to test organizationsOrganizationPlacesGet
        //instance.organizationsOrganizationPlacesGet(function(error) {
    ...
    describe('organizationsOrganizationPlacesPost', function() {
      it('should call organizationsOrganizationPlacesPost successfully', function(done) {
        //uncomment below and update the code to test organizationsOrganizationPlacesPost
        //instance.organizationsOrganizationPlacesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('placesPlaceGet', function() {
      it('should call placesPlaceGet successfully', function(done) {
        //uncomment below and update the code to test placesPlaceGet
        //instance.placesPlaceGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('placesPlacePatch', function() {
      it('should call placesPlacePatch successfully', function(done) {
        //uncomment below and update the code to test placesPlacePatch
        //instance.placesPlacePatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
