...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CommentApi();
  });
  ...
  describe('CommentApi', function() {
    describe('feedbacksFeedbackCommentsGet', function() {
      it('should call feedbacksFeedbackCommentsGet successfully', function(done) {
        //uncomment below and update the code to test feedbacksFeedbackCommentsGet
        //instance.feedbacksFeedbackCommentsGet(function(error) {
    ...
    describe('feedbacksFeedbackCommentsPost', function() {
      it('should call feedbacksFeedbackCommentsPost successfully', function(done) {
        //uncomment below and update the code to test feedbacksFeedbackCommentsPost
        //instance.feedbacksFeedbackCommentsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('operationsOperationCommentsGet', function() {
      it('should call operationsOperationCommentsGet successfully', function(done) {
        //uncomment below and update the code to test operationsOperationCommentsGet
        //instance.operationsOperationCommentsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('operationsOperationCommentsPost', function() {
      it('should call operationsOperationCommentsPost successfully', function(done) {
        //uncomment below and update the code to test operationsOperationCommentsPost
        //instance.operationsOperationCommentsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
