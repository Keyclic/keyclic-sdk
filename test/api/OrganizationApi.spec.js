...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OrganizationApi();
  });
  ...
  describe('OrganizationApi', function() {
    ...
    describe('organizationsOrganizationGet', function() {
      it('should call organizationsOrganizationGet successfully', function(done) {
        //uncomment below and update the code to test organizationsOrganizationGet
        //instance.organizationsOrganizationGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organizationsOrganizationMembersGet', function() {
      it('should call organizationsOrganizationMembersGet successfully', function(done) {
        //uncomment below and update the code to test organizationsOrganizationMembersGet
        //instance.organizationsOrganizationMembersGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organizationsOrganizationOperationsGet', function() {
      it('should call organizationsOrganizationOperationsGet successfully', function(done) {
        //uncomment below and update the code to test organizationsOrganizationOperationsGet
        //instance.organizationsOrganizationOperationsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organizationsOrganizationPatch', function() {
      it('should call organizationsOrganizationPatch successfully', function(done) {
        //uncomment below and update the code to test organizationsOrganizationPatch
        //instance.organizationsOrganizationPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organizationsOrganizationRelationshipsGet', function() {
      it('should call organizationsOrganizationRelationshipsGet successfully', function(done) {
        //uncomment below and update the code to test organizationsOrganizationRelationshipsGet
        //instance.organizationsOrganizationRelationshipsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
