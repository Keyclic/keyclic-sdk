...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ApplicationApi();
  });
  ...
  describe('ApplicationApi', function() {
    describe('applicationsApplicationGet', function() {
      it('should call applicationsApplicationGet successfully', function(done) {
        //uncomment below and update the code to test applicationsApplicationGet
        //instance.applicationsApplicationGet(function(error) {
