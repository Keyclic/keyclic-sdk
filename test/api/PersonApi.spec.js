...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PersonApi();
  });
  ...
  describe('PersonApi', function() {
    describe('peopleGet', function() {
      it('should call peopleGet successfully', function(done) {
        //uncomment below and update the code to test peopleGet
        //instance.peopleGet(function(error) {
    ...
    describe('peoplePersonGet', function() {
      it('should call peoplePersonGet successfully', function(done) {
        //uncomment below and update the code to test peoplePersonGet
        //instance.peoplePersonGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('peoplePersonPatch', function() {
      it('should call peoplePersonPatch successfully', function(done) {
        //uncomment below and update the code to test peoplePersonPatch
        //instance.peoplePersonPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
