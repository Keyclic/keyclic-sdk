...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ContributionApi();
  });
  ...
  describe('ContributionApi', function() {
    describe('feedbacksFeedbackContributionsGet', function() {
      it('should call feedbacksFeedbackContributionsGet successfully', function(done) {
        //uncomment below and update the code to test feedbacksFeedbackContributionsGet
        //instance.feedbacksFeedbackContributionsGet(function(error) {
    ...
    describe('feedbacksFeedbackContributionsPost', function() {
      it('should call feedbacksFeedbackContributionsPost successfully', function(done) {
        //uncomment below and update the code to test feedbacksFeedbackContributionsPost
        //instance.feedbacksFeedbackContributionsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
