...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.RelationshipApi();
  });
  ...
  describe('RelationshipApi', function() {
    describe('cgetByOrganization', function() {
      it('should call cgetByOrganization successfully', function(done) {
        //uncomment below and update the code to test cgetByOrganization
        //instance.cgetByOrganization(function(error) {
