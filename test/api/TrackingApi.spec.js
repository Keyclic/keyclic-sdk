...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.TrackingApi();
  });
  ...
  describe('TrackingApi', function() {
    describe('cgetByFeedback', function() {
      it('should call cgetByFeedback successfully', function(done) {
        //uncomment below and update the code to test cgetByFeedback
        //instance.cgetByFeedback(function(error) {
