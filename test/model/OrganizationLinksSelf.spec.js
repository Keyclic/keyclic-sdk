...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OrganizationLinksSelf();
  });
  ...
  describe('OrganizationLinksSelf', function() {
    it('should create an instance of OrganizationLinksSelf', function() {
      ...
      //var instane = new KeyclicApiReference.OrganizationLinksSelf();
      //expect(instance).to.be.a(KeyclicApiReference.OrganizationLinksSelf);
    });
