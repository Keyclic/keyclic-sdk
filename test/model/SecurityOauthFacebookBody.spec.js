...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.SecurityOauthFacebookBody();
  });
  ...
  describe('SecurityOauthFacebookBody', function() {
    it('should create an instance of SecurityOauthFacebookBody', function() {
      // uncomment below and update the code to test SecurityOauthFacebookBody
      //var instane = new KeyclicApiReference.SecurityOauthFacebookBody();
      //expect(instance).to.be.a(KeyclicApiReference.SecurityOauthFacebookBody);
    });
