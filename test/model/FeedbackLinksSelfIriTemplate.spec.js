...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksSelfIriTemplate();
  });
  ...
  describe('FeedbackLinksSelfIriTemplate', function() {
    it('should create an instance of FeedbackLinksSelfIriTemplate', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksSelfIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksSelfIriTemplate);
    });
