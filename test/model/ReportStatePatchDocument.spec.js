...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportStatePatchDocument();
  });
  ...
  describe('ReportStatePatchDocument', function() {
    it('should create an instance of ReportStatePatchDocument', function() {
      // uncomment below and update the code to test ReportStatePatchDocument
      //var instane = new KeyclicApiReference.ReportStatePatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.ReportStatePatchDocument);
    });
