...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryBody();
  });
  ...
  describe('CategoryBody', function() {
    it('should create an instance of CategoryBody', function() {
      // uncomment below and update the code to test CategoryBody
      //var instane = new KeyclicApiReference.CategoryBody();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryBody);
    });
