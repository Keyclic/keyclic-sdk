...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksImageIriTemplate();
  });
  ...
  describe('FeedbackLinksImageIriTemplate', function() {
    it('should create an instance of FeedbackLinksImageIriTemplate', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksImageIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksImageIriTemplate);
    });
