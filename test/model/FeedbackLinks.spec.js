...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinks();
  });
  ...
  describe('FeedbackLinks', function() {
    it('should create an instance of FeedbackLinks', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinks();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinks);
    });
