...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryLinksOrganization();
  });
  ...
  describe('CategoryLinksOrganization', function() {
    it('should create an instance of CategoryLinksOrganization', function() {
      ...
      //var instane = new KeyclicApiReference.CategoryLinksOrganization();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryLinksOrganization);
    });
