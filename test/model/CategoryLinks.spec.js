...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryLinks();
  });
  ...
  describe('CategoryLinks', function() {
    it('should create an instance of CategoryLinks', function() {
      ...
      //var instane = new KeyclicApiReference.CategoryLinks();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryLinks);
    });
