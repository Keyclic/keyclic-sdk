...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PlaceLinksSelfIriTemplateMapping();
  });
  ...
  describe('PlaceLinksSelfIriTemplateMapping', function() {
    it('should create an instance of PlaceLinksSelfIriTemplateMapping', function() {
      // uncomment below and update the code to test PlaceLinksSelfIriTemplateMapping
      //var instane = new KeyclicApiReference.PlaceLinksSelfIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.PlaceLinksSelfIriTemplateMapping);
    });
