...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackPagination();
  });
  ...
  describe('FeedbackPagination', function() {
    it('should create an instance of FeedbackPagination', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackPagination();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackPagination);
    });
