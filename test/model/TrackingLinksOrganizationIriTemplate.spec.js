...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.TrackingLinksOrganizationIriTemplate();
  });
  ...
  describe('TrackingLinksOrganizationIriTemplate', function() {
    it('should create an instance of TrackingLinksOrganizationIriTemplate', function() {
      // uncomment below and update the code to test TrackingLinksOrganizationIriTemplate
      //var instane = new KeyclicApiReference.TrackingLinksOrganizationIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.TrackingLinksOrganizationIriTemplate);
    });
