...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PersonPagination();
  });
  ...
  describe('PersonPagination', function() {
    it('should create an instance of PersonPagination', function() {
      ...
      //var instane = new KeyclicApiReference.PersonPagination();
      //expect(instance).to.be.a(KeyclicApiReference.PersonPagination);
    });
