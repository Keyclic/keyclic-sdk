...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationPaginationEmbedded();
  });
  ...
  describe('OperationPaginationEmbedded', function() {
    it('should create an instance of OperationPaginationEmbedded', function() {
      // uncomment below and update the code to test OperationPaginationEmbedded
      //var instane = new KeyclicApiReference.OperationPaginationEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.OperationPaginationEmbedded);
    });
