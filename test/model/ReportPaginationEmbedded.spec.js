...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportPaginationEmbedded();
  });
  ...
  describe('ReportPaginationEmbedded', function() {
    it('should create an instance of ReportPaginationEmbedded', function() {
      // uncomment below and update the code to test ReportPaginationEmbedded
      //var instane = new KeyclicApiReference.ReportPaginationEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.ReportPaginationEmbedded);
    });
