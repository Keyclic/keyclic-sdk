...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportPatchDocument();
  });
  ...
  describe('ReportPatchDocument', function() {
    it('should create an instance of ReportPatchDocument', function() {
      // uncomment below and update the code to test ReportPatchDocument
      //var instane = new KeyclicApiReference.ReportPatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.ReportPatchDocument);
    });
