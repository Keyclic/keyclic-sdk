...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryPagination();
  });
  ...
  describe('CategoryPagination', function() {
    it('should create an instance of CategoryPagination', function() {
      ...
      //var instane = new KeyclicApiReference.CategoryPagination();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryPagination);
    });
