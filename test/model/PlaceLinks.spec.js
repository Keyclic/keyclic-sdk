...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PlaceLinks();
  });
  ...
  describe('PlaceLinks', function() {
    it('should create an instance of PlaceLinks', function() {
      // uncomment below and update the code to test PlaceLinks
      //var instane = new KeyclicApiReference.PlaceLinks();
      //expect(instance).to.be.a(KeyclicApiReference.PlaceLinks);
    });
