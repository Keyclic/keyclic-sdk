...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.GeoCoordinatesBody();
  });
  ...
  describe('GeoCoordinatesBody', function() {
    it('should create an instance of GeoCoordinatesBody', function() {
      // uncomment below and update the code to test GeoCoordinatesBody
      //var instane = new KeyclicApiReference.GeoCoordinatesBody();
      //expect(instance).to.be.a(KeyclicApiReference.GeoCoordinatesBody);
    });
