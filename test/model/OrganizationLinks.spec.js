...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OrganizationLinks();
  });
  ...
  describe('OrganizationLinks', function() {
    it('should create an instance of OrganizationLinks', function() {
      ...
      //var instane = new KeyclicApiReference.OrganizationLinks();
      //expect(instance).to.be.a(KeyclicApiReference.OrganizationLinks);
    });
