...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportLinksTracking();
  });
  ...
  describe('ReportLinksTracking', function() {
    it('should create an instance of ReportLinksTracking', function() {
      ...
      //var instane = new KeyclicApiReference.ReportLinksTracking();
      //expect(instance).to.be.a(KeyclicApiReference.ReportLinksTracking);
    });
