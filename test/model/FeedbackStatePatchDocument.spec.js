...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackStatePatchDocument();
  });
  ...
  describe('FeedbackStatePatchDocument', function() {
    it('should create an instance of FeedbackStatePatchDocument', function() {
      // uncomment below and update the code to test FeedbackStatePatchDocument
      //var instane = new KeyclicApiReference.FeedbackStatePatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackStatePatchDocument);
    });
