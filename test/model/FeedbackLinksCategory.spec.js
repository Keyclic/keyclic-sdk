...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksCategory();
  });
  ...
  describe('FeedbackLinksCategory', function() {
    it('should create an instance of FeedbackLinksCategory', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksCategory();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksCategory);
    });
