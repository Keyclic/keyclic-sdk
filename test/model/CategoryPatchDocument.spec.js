...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryPatchDocument();
  });
  ...
  describe('CategoryPatchDocument', function() {
    it('should create an instance of CategoryPatchDocument', function() {
      // uncomment below and update the code to test CategoryPatchDocument
      //var instane = new KeyclicApiReference.CategoryPatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryPatchDocument);
    });
