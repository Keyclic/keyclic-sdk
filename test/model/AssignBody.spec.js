...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.AssignBody();
  });
  ...
  describe('AssignBody', function() {
    it('should create an instance of AssignBody', function() {
      // uncomment below and update the code to test AssignBody
      //var instane = new KeyclicApiReference.AssignBody();
      //expect(instance).to.be.a(KeyclicApiReference.AssignBody);
    });
