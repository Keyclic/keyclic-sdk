...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationLinksReport();
  });
  ...
  describe('OperationLinksReport', function() {
    it('should create an instance of OperationLinksReport', function() {
      ...
      //var instane = new KeyclicApiReference.OperationLinksReport();
      //expect(instance).to.be.a(KeyclicApiReference.OperationLinksReport);
    });
