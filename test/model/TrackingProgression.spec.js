...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.TrackingProgression();
  });
  ...
  describe('TrackingProgression', function() {
    it('should create an instance of TrackingProgression', function() {
      ...
      //var instane = new KeyclicApiReference.TrackingProgression();
      //expect(instance).to.be.a(KeyclicApiReference.TrackingProgression);
    });
