...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.GeoCoordinates();
  });
  ...
  describe('GeoCoordinates', function() {
    it('should create an instance of GeoCoordinates', function() {
      ...
      //var instane = new KeyclicApiReference.GeoCoordinates();
      //expect(instance).to.be.a(KeyclicApiReference.GeoCoordinates);
    });
