...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.TrackingLinks();
  });
  ...
  describe('TrackingLinks', function() {
    it('should create an instance of TrackingLinks', function() {
      // uncomment below and update the code to test TrackingLinks
      //var instane = new KeyclicApiReference.TrackingLinks();
      //expect(instance).to.be.a(KeyclicApiReference.TrackingLinks);
    });
