...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryPaginationLinks();
  });
  ...
  describe('CategoryPaginationLinks', function() {
    it('should create an instance of CategoryPaginationLinks', function() {
      // uncomment below and update the code to test CategoryPaginationLinks
      //var instane = new KeyclicApiReference.CategoryPaginationLinks();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryPaginationLinks);
    });
