...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.TrackingLinksOrganizationIriTemplateMapping();
  });
  ...
  describe('TrackingLinksOrganizationIriTemplateMapping', function() {
    it('should create an instance of TrackingLinksOrganizationIriTemplateMapping', function() {
      // uncomment below and update the code to test TrackingLinksOrganizationIriTemplateMapping
      //var instane = new KeyclicApiReference.TrackingLinksOrganizationIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.TrackingLinksOrganizationIriTemplateMapping);
    });
