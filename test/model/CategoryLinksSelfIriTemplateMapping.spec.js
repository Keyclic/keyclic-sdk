...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryLinksSelfIriTemplateMapping();
  });
  ...
  describe('CategoryLinksSelfIriTemplateMapping', function() {
    it('should create an instance of CategoryLinksSelfIriTemplateMapping', function() {
      ...
      //var instane = new KeyclicApiReference.CategoryLinksSelfIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryLinksSelfIriTemplateMapping);
    });
