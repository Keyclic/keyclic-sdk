...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackBody();
  });
  ...
  describe('FeedbackBody', function() {
    it('should create an instance of FeedbackBody', function() {
      // uncomment below and update the code to test FeedbackBody
      //var instane = new KeyclicApiReference.FeedbackBody();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackBody);
    });
