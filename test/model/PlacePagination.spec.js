...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PlacePagination();
  });
  ...
  describe('PlacePagination', function() {
    it('should create an instance of PlacePagination', function() {
      ...
      //var instane = new KeyclicApiReference.PlacePagination();
      //expect(instance).to.be.a(KeyclicApiReference.PlacePagination);
    });
