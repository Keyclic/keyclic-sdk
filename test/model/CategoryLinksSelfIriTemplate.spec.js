...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryLinksSelfIriTemplate();
  });
  ...
  describe('CategoryLinksSelfIriTemplate', function() {
    it('should create an instance of CategoryLinksSelfIriTemplate', function() {
      ...
      //var instane = new KeyclicApiReference.CategoryLinksSelfIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryLinksSelfIriTemplate);
    });
