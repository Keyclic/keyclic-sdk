...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationPatchDocument();
  });
  ...
  describe('OperationPatchDocument', function() {
    it('should create an instance of OperationPatchDocument', function() {
      ...
      //var instane = new KeyclicApiReference.OperationPatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.OperationPatchDocument);
    });
