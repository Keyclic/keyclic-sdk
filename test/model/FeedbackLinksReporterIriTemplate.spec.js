...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksReporterIriTemplate();
  });
  ...
  describe('FeedbackLinksReporterIriTemplate', function() {
    it('should create an instance of FeedbackLinksReporterIriTemplate', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksReporterIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksReporterIriTemplate);
    });
