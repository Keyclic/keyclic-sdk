...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationBody();
  });
  ...
  describe('OperationBody', function() {
    it('should create an instance of OperationBody', function() {
      // uncomment below and update the code to test OperationBody
      //var instane = new KeyclicApiReference.OperationBody();
      //expect(instance).to.be.a(KeyclicApiReference.OperationBody);
    });
