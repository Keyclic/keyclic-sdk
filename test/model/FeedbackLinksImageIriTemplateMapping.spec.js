...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksImageIriTemplateMapping();
  });
  ...
  describe('FeedbackLinksImageIriTemplateMapping', function() {
    it('should create an instance of FeedbackLinksImageIriTemplateMapping', function() {
      // uncomment below and update the code to test FeedbackLinksImageIriTemplateMapping
      //var instane = new KeyclicApiReference.FeedbackLinksImageIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksImageIriTemplateMapping);
    });
