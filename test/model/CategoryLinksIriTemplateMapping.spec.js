...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryLinksIriTemplateMapping();
  });
  ...
  describe('CategoryLinksIriTemplateMapping', function() {
    it('should create an instance of CategoryLinksIriTemplateMapping', function() {
      // uncomment below and update the code to test CategoryLinksIriTemplateMapping
      //var instane = new KeyclicApiReference.CategoryLinksIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryLinksIriTemplateMapping);
    });
