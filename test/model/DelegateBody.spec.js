...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.DelegateBody();
  });
  ...
  describe('DelegateBody', function() {
    it('should create an instance of DelegateBody', function() {
      // uncomment below and update the code to test DelegateBody
      //var instane = new KeyclicApiReference.DelegateBody();
      //expect(instance).to.be.a(KeyclicApiReference.DelegateBody);
    });
