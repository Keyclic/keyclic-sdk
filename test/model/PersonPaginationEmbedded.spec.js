...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PersonPaginationEmbedded();
  });
  ...
  describe('PersonPaginationEmbedded', function() {
    it('should create an instance of PersonPaginationEmbedded', function() {
      // uncomment below and update the code to test PersonPaginationEmbedded
      //var instane = new KeyclicApiReference.PersonPaginationEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.PersonPaginationEmbedded);
    });
