...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationStatePatchDocument();
  });
  ...
  describe('OperationStatePatchDocument', function() {
    it('should create an instance of OperationStatePatchDocument', function() {
      // uncomment below and update the code to test OperationStatePatchDocument
      //var instane = new KeyclicApiReference.OperationStatePatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.OperationStatePatchDocument);
    });
