...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ErrorEmbedded();
  });
  ...
  describe('ErrorEmbedded', function() {
    it('should create an instance of ErrorEmbedded', function() {
      ...
      //var instane = new KeyclicApiReference.ErrorEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.ErrorEmbedded);
    });
