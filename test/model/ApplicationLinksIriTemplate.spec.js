...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ApplicationLinksIriTemplate();
  });
  ...
  describe('ApplicationLinksIriTemplate', function() {
    it('should create an instance of ApplicationLinksIriTemplate', function() {
      // uncomment below and update the code to test ApplicationLinksIriTemplate
      //var instane = new KeyclicApiReference.ApplicationLinksIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.ApplicationLinksIriTemplate);
    });
