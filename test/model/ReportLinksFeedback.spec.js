...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportLinksFeedback();
  });
  ...
  describe('ReportLinksFeedback', function() {
    it('should create an instance of ReportLinksFeedback', function() {
      ...
      //var instane = new KeyclicApiReference.ReportLinksFeedback();
      //expect(instance).to.be.a(KeyclicApiReference.ReportLinksFeedback);
    });
