...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PersonLinksSelf();
  });
  ...
  describe('PersonLinksSelf', function() {
    it('should create an instance of PersonLinksSelf', function() {
      ...
      //var instane = new KeyclicApiReference.PersonLinksSelf();
      //expect(instance).to.be.a(KeyclicApiReference.PersonLinksSelf);
    });
