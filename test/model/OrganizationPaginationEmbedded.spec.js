...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OrganizationPaginationEmbedded();
  });
  ...
  describe('OrganizationPaginationEmbedded', function() {
    it('should create an instance of OrganizationPaginationEmbedded', function() {
      // uncomment below and update the code to test OrganizationPaginationEmbedded
      //var instane = new KeyclicApiReference.OrganizationPaginationEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.OrganizationPaginationEmbedded);
    });
