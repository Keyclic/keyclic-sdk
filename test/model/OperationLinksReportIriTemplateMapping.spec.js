...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationLinksReportIriTemplateMapping();
  });
  ...
  describe('OperationLinksReportIriTemplateMapping', function() {
    it('should create an instance of OperationLinksReportIriTemplateMapping', function() {
      ...
      //var instane = new KeyclicApiReference.OperationLinksReportIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.OperationLinksReportIriTemplateMapping);
    });
