...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationPagination();
  });
  ...
  describe('OperationPagination', function() {
    it('should create an instance of OperationPagination', function() {
      ...
      //var instane = new KeyclicApiReference.OperationPagination();
      //expect(instance).to.be.a(KeyclicApiReference.OperationPagination);
    });
