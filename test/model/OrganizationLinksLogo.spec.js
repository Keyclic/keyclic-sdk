...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OrganizationLinksLogo();
  });
  ...
  describe('OrganizationLinksLogo', function() {
    it('should create an instance of OrganizationLinksLogo', function() {
      ...
      //var instane = new KeyclicApiReference.OrganizationLinksLogo();
      //expect(instance).to.be.a(KeyclicApiReference.OrganizationLinksLogo);
    });
