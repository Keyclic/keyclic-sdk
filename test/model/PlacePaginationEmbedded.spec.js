...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PlacePaginationEmbedded();
  });
  ...
  describe('PlacePaginationEmbedded', function() {
    it('should create an instance of PlacePaginationEmbedded', function() {
      // uncomment below and update the code to test PlacePaginationEmbedded
      //var instane = new KeyclicApiReference.PlacePaginationEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.PlacePaginationEmbedded);
    });
