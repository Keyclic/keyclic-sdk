...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OrganizationPagination();
  });
  ...
  describe('OrganizationPagination', function() {
    it('should create an instance of OrganizationPagination', function() {
      ...
      //var instane = new KeyclicApiReference.OrganizationPagination();
      //expect(instance).to.be.a(KeyclicApiReference.OrganizationPagination);
    });
