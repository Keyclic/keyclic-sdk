...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.TrackingLinksOrganization();
  });
  ...
  describe('TrackingLinksOrganization', function() {
    it('should create an instance of TrackingLinksOrganization', function() {
      // uncomment below and update the code to test TrackingLinksOrganization
      //var instane = new KeyclicApiReference.TrackingLinksOrganization();
      //expect(instance).to.be.a(KeyclicApiReference.TrackingLinksOrganization);
    });
