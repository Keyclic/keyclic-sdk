...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksSelfIriTemplateMapping();
  });
  ...
  describe('FeedbackLinksSelfIriTemplateMapping', function() {
    it('should create an instance of FeedbackLinksSelfIriTemplateMapping', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksSelfIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksSelfIriTemplateMapping);
    });
