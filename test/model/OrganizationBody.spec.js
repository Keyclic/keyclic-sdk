...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OrganizationBody();
  });
  ...
  describe('OrganizationBody', function() {
    it('should create an instance of OrganizationBody', function() {
      // uncomment below and update the code to test OrganizationBody
      //var instane = new KeyclicApiReference.OrganizationBody();
      //expect(instance).to.be.a(KeyclicApiReference.OrganizationBody);
    });
