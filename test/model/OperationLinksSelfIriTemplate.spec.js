...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationLinksSelfIriTemplate();
  });
  ...
  describe('OperationLinksSelfIriTemplate', function() {
    it('should create an instance of OperationLinksSelfIriTemplate', function() {
      ...
      //var instane = new KeyclicApiReference.OperationLinksSelfIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.OperationLinksSelfIriTemplate);
    });
