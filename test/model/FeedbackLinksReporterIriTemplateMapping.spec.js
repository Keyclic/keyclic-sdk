...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksReporterIriTemplateMapping();
  });
  ...
  describe('FeedbackLinksReporterIriTemplateMapping', function() {
    it('should create an instance of FeedbackLinksReporterIriTemplateMapping', function() {
      // uncomment below and update the code to test FeedbackLinksReporterIriTemplateMapping
      //var instane = new KeyclicApiReference.FeedbackLinksReporterIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksReporterIriTemplateMapping);
    });
