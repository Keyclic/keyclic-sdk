...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.TrackingCheckpoints();
  });
  ...
  describe('TrackingCheckpoints', function() {
    it('should create an instance of TrackingCheckpoints', function() {
      // uncomment below and update the code to test TrackingCheckpoints
      //var instane = new KeyclicApiReference.TrackingCheckpoints();
      //expect(instance).to.be.a(KeyclicApiReference.TrackingCheckpoints);
    });
