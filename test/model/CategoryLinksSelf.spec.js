...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryLinksSelf();
  });
  ...
  describe('CategoryLinksSelf', function() {
    it('should create an instance of CategoryLinksSelf', function() {
      ...
      //var instane = new KeyclicApiReference.CategoryLinksSelf();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryLinksSelf);
    });
