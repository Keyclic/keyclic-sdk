...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationLinks();
  });
  ...
  describe('OperationLinks', function() {
    it('should create an instance of OperationLinks', function() {
      // uncomment below and update the code to test OperationLinks
      //var instane = new KeyclicApiReference.OperationLinks();
      //expect(instance).to.be.a(KeyclicApiReference.OperationLinks);
    });
