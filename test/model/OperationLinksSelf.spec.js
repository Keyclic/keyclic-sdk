...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationLinksSelf();
  });
  ...
  describe('OperationLinksSelf', function() {
    it('should create an instance of OperationLinksSelf', function() {
      ...
      //var instane = new KeyclicApiReference.OperationLinksSelf();
      //expect(instance).to.be.a(KeyclicApiReference.OperationLinksSelf);
    });
