...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PlacePatchDocument();
  });
  ...
  describe('PlacePatchDocument', function() {
    it('should create an instance of PlacePatchDocument', function() {
      // uncomment below and update the code to test PlacePatchDocument
      //var instane = new KeyclicApiReference.PlacePatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.PlacePatchDocument);
    });
