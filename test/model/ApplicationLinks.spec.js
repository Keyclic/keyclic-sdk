...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ApplicationLinks();
  });
  ...
  describe('ApplicationLinks', function() {
    it('should create an instance of ApplicationLinks', function() {
      // uncomment below and update the code to test ApplicationLinks
      //var instane = new KeyclicApiReference.ApplicationLinks();
      //expect(instance).to.be.a(KeyclicApiReference.ApplicationLinks);
    });
