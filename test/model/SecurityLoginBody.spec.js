...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.SecurityLoginBody();
  });
  ...
  describe('SecurityLoginBody', function() {
    it('should create an instance of SecurityLoginBody', function() {
      // uncomment below and update the code to test SecurityLoginBody
      //var instane = new KeyclicApiReference.SecurityLoginBody();
      //expect(instance).to.be.a(KeyclicApiReference.SecurityLoginBody);
    });
