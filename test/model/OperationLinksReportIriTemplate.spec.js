...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationLinksReportIriTemplate();
  });
  ...
  describe('OperationLinksReportIriTemplate', function() {
    it('should create an instance of OperationLinksReportIriTemplate', function() {
      ...
      //var instane = new KeyclicApiReference.OperationLinksReportIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.OperationLinksReportIriTemplate);
    });
