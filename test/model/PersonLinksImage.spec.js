...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PersonLinksImage();
  });
  ...
  describe('PersonLinksImage', function() {
    it('should create an instance of PersonLinksImage', function() {
      ...
      //var instane = new KeyclicApiReference.PersonLinksImage();
      //expect(instance).to.be.a(KeyclicApiReference.PersonLinksImage);
    });
