...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ApplicationLinksIriTemplateMapping();
  });
  ...
  describe('ApplicationLinksIriTemplateMapping', function() {
    it('should create an instance of ApplicationLinksIriTemplateMapping', function() {
      // uncomment below and update the code to test ApplicationLinksIriTemplateMapping
      //var instane = new KeyclicApiReference.ApplicationLinksIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.ApplicationLinksIriTemplateMapping);
    });
