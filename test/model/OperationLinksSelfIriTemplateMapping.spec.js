...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.OperationLinksSelfIriTemplateMapping();
  });
  ...
  describe('OperationLinksSelfIriTemplateMapping', function() {
    it('should create an instance of OperationLinksSelfIriTemplateMapping', function() {
      ...
      //var instane = new KeyclicApiReference.OperationLinksSelfIriTemplateMapping();
      //expect(instance).to.be.a(KeyclicApiReference.OperationLinksSelfIriTemplateMapping);
    });
