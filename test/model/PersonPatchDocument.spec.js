...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PersonPatchDocument();
  });
  ...
  describe('PersonPatchDocument', function() {
    it('should create an instance of PersonPatchDocument', function() {
      // uncomment below and update the code to test PersonPatchDocument
      //var instane = new KeyclicApiReference.PersonPatchDocument();
      //expect(instance).to.be.a(KeyclicApiReference.PersonPatchDocument);
    });
