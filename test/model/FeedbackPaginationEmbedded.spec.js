...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackPaginationEmbedded();
  });
  ...
  describe('FeedbackPaginationEmbedded', function() {
    it('should create an instance of FeedbackPaginationEmbedded', function() {
      // uncomment below and update the code to test FeedbackPaginationEmbedded
      //var instane = new KeyclicApiReference.FeedbackPaginationEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackPaginationEmbedded);
    });
