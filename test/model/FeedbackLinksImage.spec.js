...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksImage();
  });
  ...
  describe('FeedbackLinksImage', function() {
    it('should create an instance of FeedbackLinksImage', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksImage();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksImage);
    });
