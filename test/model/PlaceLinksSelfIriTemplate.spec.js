...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.PlaceLinksSelfIriTemplate();
  });
  ...
  describe('PlaceLinksSelfIriTemplate', function() {
    it('should create an instance of PlaceLinksSelfIriTemplate', function() {
      ...
      //var instane = new KeyclicApiReference.PlaceLinksSelfIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.PlaceLinksSelfIriTemplate);
    });
