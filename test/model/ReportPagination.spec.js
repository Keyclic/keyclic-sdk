...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportPagination();
  });
  ...
  describe('ReportPagination', function() {
    it('should create an instance of ReportPagination', function() {
      ...
      //var instane = new KeyclicApiReference.ReportPagination();
      //expect(instance).to.be.a(KeyclicApiReference.ReportPagination);
    });
