...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksSelf();
  });
  ...
  describe('FeedbackLinksSelf', function() {
    it('should create an instance of FeedbackLinksSelf', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksSelf();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksSelf);
    });
