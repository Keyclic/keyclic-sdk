...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryPaginationEmbedded();
  });
  ...
  describe('CategoryPaginationEmbedded', function() {
    it('should create an instance of CategoryPaginationEmbedded', function() {
      // uncomment below and update the code to test CategoryPaginationEmbedded
      //var instane = new KeyclicApiReference.CategoryPaginationEmbedded();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryPaginationEmbedded);
    });
