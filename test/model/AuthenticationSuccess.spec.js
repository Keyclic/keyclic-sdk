...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.AuthenticationSuccess();
  });
  ...
  describe('AuthenticationSuccess', function() {
    it('should create an instance of AuthenticationSuccess', function() {
      // uncomment below and update the code to test AuthenticationSuccess
      //var instane = new KeyclicApiReference.AuthenticationSuccess();
      //expect(instance).to.be.a(KeyclicApiReference.AuthenticationSuccess);
    });
