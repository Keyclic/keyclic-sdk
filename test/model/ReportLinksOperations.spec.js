...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportLinksOperations();
  });
  ...
  describe('ReportLinksOperations', function() {
    it('should create an instance of ReportLinksOperations', function() {
      ...
      //var instane = new KeyclicApiReference.ReportLinksOperations();
      //expect(instance).to.be.a(KeyclicApiReference.ReportLinksOperations);
    });
