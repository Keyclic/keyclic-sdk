...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ApplicationLinksSelf();
  });
  ...
  describe('ApplicationLinksSelf', function() {
    it('should create an instance of ApplicationLinksSelf', function() {
      ...
      //var instane = new KeyclicApiReference.ApplicationLinksSelf();
      //expect(instance).to.be.a(KeyclicApiReference.ApplicationLinksSelf);
    });
