...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.FeedbackLinksReporter();
  });
  ...
  describe('FeedbackLinksReporter', function() {
    it('should create an instance of FeedbackLinksReporter', function() {
      ...
      //var instane = new KeyclicApiReference.FeedbackLinksReporter();
      //expect(instance).to.be.a(KeyclicApiReference.FeedbackLinksReporter);
    });
