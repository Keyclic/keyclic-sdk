...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.CategoryLinksIriTemplate();
  });
  ...
  describe('CategoryLinksIriTemplate', function() {
    it('should create an instance of CategoryLinksIriTemplate', function() {
      // uncomment below and update the code to test CategoryLinksIriTemplate
      //var instane = new KeyclicApiReference.CategoryLinksIriTemplate();
      //expect(instance).to.be.a(KeyclicApiReference.CategoryLinksIriTemplate);
    });
