...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyclicApiReference.ReportLinksSelf();
  });
  ...
  describe('ReportLinksSelf', function() {
    it('should create an instance of ReportLinksSelf', function() {
      ...
      //var instane = new KeyclicApiReference.ReportLinksSelf();
      //expect(instance).to.be.a(KeyclicApiReference.ReportLinksSelf);
    });
