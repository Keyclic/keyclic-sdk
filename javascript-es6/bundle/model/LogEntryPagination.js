...
var _LogEntryCollection = _interopRequireDefault(
  require("./LogEntryCollection")
);
...
var LogEntryPagination =
   ...
   */
    function LogEntryPagination() {
      _classCallCheck(this, LogEntryPagination);
      ...
      this.embedded = null;
      this.links = null;
      this.embeddedType = _LogEntryCollection.default;
    ...
    _createClass(LogEntryPagination, null, [
      {
    ...
    return LogEntryPagination;
  })();

exports.default = LogEntryPagination;
