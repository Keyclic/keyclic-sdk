...
/**
 * The ItemsChoice model module.
 * @module model/ItemsChoice
 */
var ItemsChoice = /*#__PURE__*/ (function() {
  /**
   * Constructs a new "ItemsChoice".
   * @alias module:model/ItemsChoice
   * @class
  
   */
  function ItemsChoice() {
    _classCallCheck(this, ItemsChoice);
  ...
  /**
   * Constructs a "ItemsChoice" from a plain JavaScript object.
   * @param { object } data The plain JavaScript object bearing properties of interest.
   * @param { module:model/ItemsChoice } object Optional instance to populate.
   * @return { module:model/ItemsChoice } The populated "ItemsChoice" instance.
   */
