...
var FeedbackReviewRequestPagination =
  ...
  (function(_Pagination) {
    _inherits(FeedbackReviewRequestPagination, _Pagination);
   ...
   */
    function FeedbackReviewRequestPagination() {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(FeedbackReviewRequestPagination).call(this)
      );
      _this.embedded = null;
      _this.embeddedType = _FeedbackReviewRequestCollection.default;
      return _this;
    }
    /**
      ...
      [
        {
          ...
          /**
           * @return { module:model/FeedbackReviewRequestCollection }
           */
          value: function getEmbedded() {
            return this.embedded;
          }
          /**
           * @param { module:model/FeedbackReviewRequestCollection } embedded
           */
        },
        {
          key: "setEmbedded",
      ...
      [
        {
          ...
          value: function constructFromData(data) {
            ...
            object = _get(
              _getPrototypeOf(FeedbackReviewRequestPagination),
              "constructFromData",
              this
