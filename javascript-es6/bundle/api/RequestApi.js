...
var RequestApi =
  /*#__PURE__*/
  (function(_ApiClient) {
    _inherits(RequestApi, _ApiClient);
    ...
    function RequestApi() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(RequestApi).call(this, basePath, headers, timeout)
      );
    }
    /**
    ...
    _createClass(RequestApi, [
      {
        key: "cgetRequestsByPerson",
        value: function cgetRequestsByPerson() {
          var returnType =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : null;
