  ...
  (function(_ApiClient) {
    ...
    function FileApi() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(FileApi).call(this, basePath, headers, timeout)
      );
    }
    /**
    ...
    _createClass(FileApi, [
      {
        key: "getFileByDocument",
        value: function getFileByDocument() {
          var returnType =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : null;
          ...
          if (typeof xKeyclicApp === "undefined" || xKeyclicApp === null) {
            throw new window.Error(
              'Missing the required parameter "xKeyclicApp" when calling getFileByDocument'
            );
          } // verify the required parameter 'document' is set

          if (typeof document === "undefined" || document === null) {
            throw new window.Error(
              'Missing the required parameter "document" when calling getFileByDocument'
            );
          ...
          if (typeof credentials === "undefined" || credentials === null) {
            throw new window.Error(
              'Missing the required parameter "credentials" when calling getFileByDocument'
            );
          }
