...
var AssignApi =
  /*#__PURE__*/
  (function(_ApiClient) {
    _inherits(AssignApi, _ApiClient);
    ...
    function AssignApi() {
      ...
      _classCallCheck(this, AssignApi);

      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(AssignApi).call(this, basePath, headers, timeout)
      );
    }
    /**
    ...
    _createClass(AssignApi, [
      {
        ...
        value: function postAssignByOperation() {
          ...
          if (typeof memberData === "undefined" || memberData === null) {
            throw new window.Error(
              'Missing the required parameter "memberData" when calling postAssignByOperation'
            );
