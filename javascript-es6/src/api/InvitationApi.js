 ...
 */
export default class InvitationApi extends ApiClient {
  /**
   * @class
   ...
   */
  deleteInvitation(returnType = null, options, credentials = null) {
    let {
      xKeyclicApp,
      invitation,
      acceptLanguage,
   ...
   * @param { String } xKeyclicAppVersion
   */
  getInvitation(returnType = null, options, credentials = null) {
    if (returnType === null) {
      returnType = Invitation;
    }
   ...
   * @param { String } xKeyclicAppVersion
   */
  postInvitation(returnType = null, options, credentials = null) {
    if (returnType === null) {
      returnType = Invitation;
    }
    ...
    const bodyParam = invitationData;
