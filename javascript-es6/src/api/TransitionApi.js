...
export default class TransitionApi extends ApiClient {
   ...
   */
  postTransitionByDelegation(returnType = null, options, credentials) {
    if (returnType === null) {
   ...
   * @param { String } xKeyclicAppVersion
   */
  postTransitionByFeedback(returnType = null, options, credentials) {
    if (returnType === null) {
      returnType = Feedback;
    }
   ...
   * @param { String } xKeyclicAppVersion
   */
  postTransitionByOperation(returnType = null, options, credentials) {
    if (returnType === null) {
   ...
   * @param { String } xKeyclicAppVersion
   */
  postTransitionByReport(returnType = null, options, credentials) {
    if (returnType === null) {
      returnType = Report;
    }
