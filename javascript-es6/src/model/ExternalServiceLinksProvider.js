...
import ExternalServiceLinksProviderIriTemplate from "./ExternalServiceLinksProviderIriTemplate";

/**
 * The ExternalServiceLinksProvider model module.
 * @module model/ExternalServiceLinksProvider
 */
export default class ExternalServiceLinksProvider {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = ExternalServiceLinksProviderIriTemplate;
  }
