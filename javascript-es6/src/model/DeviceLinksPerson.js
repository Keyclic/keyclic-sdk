...
import DeviceLinksPersonIriTemplate from "./DeviceLinksPersonIriTemplate";

/**
 * The DeviceLinksPerson model module.
 * @module model/DeviceLinksPerson
 */
export default class DeviceLinksPerson {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = DeviceLinksPersonIriTemplate;
  }
