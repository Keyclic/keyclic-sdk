...
import ArticleLinksSectionIriTemplate from "./ArticleLinksSectionIriTemplate";

/**
 * The ArticleLinksSection model module.
 * @module model/ArticleLinksSection
 */
export default class ArticleLinksSection {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = ArticleLinksSectionIriTemplate;
  }
