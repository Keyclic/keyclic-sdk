...
import OccupantLinksMemberIriTemplate from "./OccupantLinksMemberIriTemplate";

/**
 * The OccupantLinksMember model module.
 * @module model/OccupantLinksMember
 */
export default class OccupantLinksMember {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = OccupantLinksMemberIriTemplate;
  }
