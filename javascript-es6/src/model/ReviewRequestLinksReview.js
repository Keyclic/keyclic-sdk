...
import ReviewRequestLinksReviewIriTemplate from "./ReviewRequestLinksReviewIriTemplate";

/**
 * The ReviewRequestLinksReview model module.
 * @module model/ReviewRequestLinksReview
 */
export default class ReviewRequestLinksReview {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = ReviewRequestLinksReviewIriTemplate;
  }
