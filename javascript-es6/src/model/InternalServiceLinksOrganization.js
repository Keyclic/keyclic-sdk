...
import InternalServiceLinksOrganizationIriTemplate from "./InternalServiceLinksOrganizationIriTemplate";

/**
 * The InternalServiceLinksOrganization model module.
 * @module model/InternalServiceLinksOrganization
 */
export default class InternalServiceLinksOrganization {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = InternalServiceLinksOrganizationIriTemplate;
  }
