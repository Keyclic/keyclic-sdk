...
import InvitationLinksMemberIriTemplate from "./InvitationLinksMemberIriTemplate";

/**
 * The InvitationLinksMember model module.
 * @module model/InvitationLinksMember
 */
export default class InvitationLinksMember {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = InvitationLinksMemberIriTemplate;
  }
