...
import PersonLinksCreatedByIriTemplate from "./PersonLinksCreatedByIriTemplate";

/**
 * The PersonLinksCreatedBy model module.
 * @module model/PersonLinksCreatedBy
 */
export default class PersonLinksCreatedBy {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = PersonLinksCreatedByIriTemplate;
  }
