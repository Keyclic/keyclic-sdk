...
import ConfigurationLinksSelfIriTemplateMapping from "./ConfigurationLinksSelfIriTemplateMapping";

/**
 * The ConfigurationLinksSelfIriTemplate model module.
 * @module model/ConfigurationLinksSelfIriTemplate
 */
export default class ConfigurationLinksSelfIriTemplate {
  /**
  ...
  constructor() {
    ...
    this.mappingType = ConfigurationLinksSelfIriTemplateMapping;
  }
