...
import ReviewLinksItemReviewedIriTemplate from "./ReviewLinksItemReviewedIriTemplate";

/**
 * The ReviewLinksItemReviewed model module.
 * @module model/ReviewLinksItemReviewed
 */
export default class ReviewLinksItemReviewed {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = ReviewLinksItemReviewedIriTemplate;
  }
