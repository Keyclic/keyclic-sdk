...
import ExternalServiceLinksSelfIriTemplate from "./ExternalServiceLinksSelfIriTemplate";

/**
 * The ExternalServiceLinksSelf model module.
 * @module model/ExternalServiceLinksSelf
 */
export default class ExternalServiceLinksSelf {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = ExternalServiceLinksSelfIriTemplate;
  }
