...
import OrganizationPreferencesNotificationReport from "./OrganizationPreferencesNotificationReport";

/**
 * The OrganizationPreferencesNotification model module.
 * @module model/OrganizationPreferencesNotification
 */
export default class OrganizationPreferencesNotification {
  /**
  ...
  constructor() {
    ...
    this.reportType = OrganizationPreferencesNotificationReport;
  }
