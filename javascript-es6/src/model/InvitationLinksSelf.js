...
import InvitationLinksSelfIriTemplate from "./InvitationLinksSelfIriTemplate";

/**
 * The InvitationLinksSelf model module.
 * @module model/InvitationLinksSelf
 */
export default class InvitationLinksSelf {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = InvitationLinksSelfIriTemplate;
  }
