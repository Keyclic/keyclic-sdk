...
import OperationLinksImagesIriTemplate from "./OperationLinksImagesIriTemplate";

/**
 * The OperationLinksImages model module.
 * @module model/OperationLinksImages
 */
export default class OperationLinksImages {
  /**
  ...
  constructor() {
    ...
    this.iriTemplateType = OperationLinksImagesIriTemplate;
  }
