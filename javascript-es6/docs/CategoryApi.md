...
# **deleteCategory**
> deleteCategory(xKeyclicApp, category, opts)
...
let category = "category_example"; // String | The identifier of the resource.
...
apiInstance.deleteCategory(xKeyclicApp, category, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
# **postCategory**
> Category postCategory(xKeyclicApp, categoryData, opts)
...
apiInstance.postCategory(xKeyclicApp, categoryData, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
