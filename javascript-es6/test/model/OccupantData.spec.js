...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.OccupantData();
  });
  ...
  describe('OccupantData', function() {
    it('should create an instance of OccupantData', function() {
      // uncomment below and update the code to test OccupantData
      //var instane = new @KeyclicSdkJavascript.OccupantData();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.OccupantData);
    });
