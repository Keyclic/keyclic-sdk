...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.TrackingProgression();
  });
  ...
  describe('TrackingProgression', function() {
    it('should create an instance of TrackingProgression', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.TrackingProgression();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.TrackingProgression);
    });
