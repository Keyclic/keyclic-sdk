...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.OccupantLinks();
  });
  ...
  describe('OccupantLinks', function() {
    it('should create an instance of OccupantLinks', function() {
      // uncomment below and update the code to test OccupantLinks
