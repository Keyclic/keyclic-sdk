...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.GeoShape();
  });
  ...
  describe('GeoShape', function() {
    it('should create an instance of GeoShape', function() {
      // uncomment below and update the code to test GeoShape
      //var instane = new @KeyclicSdkJavascript.GeoShape();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.GeoShape);
    });
