...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.OperationPatch();
  });
  ...
  describe('OperationPatch', function() {
    it('should create an instance of OperationPatch', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.OperationPatch();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.OperationPatch);
    });
