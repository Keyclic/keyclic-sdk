...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.OperationType();
  });
  ...
  describe('OperationType', function() {
    it('should create an instance of OperationType', function() {
      // uncomment below and update the code to test OperationType
      //var instane = new @KeyclicSdkJavascript.OperationType();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.OperationType);
    });
