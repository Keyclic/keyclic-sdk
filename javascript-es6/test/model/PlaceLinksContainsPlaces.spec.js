...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PlaceLinksContainsPlaces();
  });
  ...
  describe('PlaceLinksContainsPlaces', function() {
    it('should create an instance of PlaceLinksContainsPlaces', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.PlaceLinksContainsPlaces();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.PlaceLinksContainsPlaces);
    });
