...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.CategoryPagination();
  });
  ...
  describe('CategoryPagination', function() {
    it('should create an instance of CategoryPagination', function() {
      // uncomment below and update the code to test CategoryPagination
      //var instane = new @KeyclicSdkJavascript.CategoryPagination();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.CategoryPagination);
    });
