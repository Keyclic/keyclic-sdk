...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PlaceLinksSelf();
  });
  ...
  describe('PlaceLinksSelf', function() {
    it('should create an instance of PlaceLinksSelf', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.PlaceLinksSelf();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.PlaceLinksSelf);
    });
