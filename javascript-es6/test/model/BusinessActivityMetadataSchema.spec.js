...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.BusinessActivityMetadataSchema();
  });
  ...
  describe('BusinessActivityMetadataSchema', function() {
    it('should create an instance of BusinessActivityMetadataSchema', function() {
      // uncomment below and update the code to test BusinessActivityMetadataSchema
