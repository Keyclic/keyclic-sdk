...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ServicePagination();
  });
  ...
  describe('ServicePagination', function() {
    it('should create an instance of ServicePagination', function() {
      // uncomment below and update the code to test ServicePagination
      //var instane = new @KeyclicSdkJavascript.ServicePagination();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ServicePagination);
    });
