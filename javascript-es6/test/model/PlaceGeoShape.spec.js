...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PlaceGeoShape();
  });
  ...
  describe('PlaceGeoShape', function() {
    it('should create an instance of PlaceGeoShape', function() {
      // uncomment below and update the code to test PlaceGeoShape
      //var instane = new @KeyclicSdkJavascript.PlaceGeoShape();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.PlaceGeoShape);
    });
