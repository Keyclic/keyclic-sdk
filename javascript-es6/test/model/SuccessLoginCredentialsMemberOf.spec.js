...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.SuccessLoginCredentialsMemberOf();
  });
  ...
  describe('SuccessLoginCredentialsMemberOf', function() {
    it('should create an instance of SuccessLoginCredentialsMemberOf', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.SuccessLoginCredentialsMemberOf();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.SuccessLoginCredentialsMemberOf);
    });
