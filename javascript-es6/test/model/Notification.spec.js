...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.Notification();
  });
  ...
  describe('Notification', function() {
    it('should create an instance of Notification', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.Notification();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.Notification);
    });
