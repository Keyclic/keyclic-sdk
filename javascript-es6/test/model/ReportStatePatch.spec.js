...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ReportStatePatch();
  });
  ...
  describe('ReportStatePatch', function() {
    it('should create an instance of ReportStatePatch', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.ReportStatePatch();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ReportStatePatch);
    });
