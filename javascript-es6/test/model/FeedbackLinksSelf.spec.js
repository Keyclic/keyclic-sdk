...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.FeedbackLinksSelf();
  });
  ...
  describe('FeedbackLinksSelf', function() {
    it('should create an instance of FeedbackLinksSelf', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.FeedbackLinksSelf();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.FeedbackLinksSelf);
    });
