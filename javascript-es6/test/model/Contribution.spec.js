...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.Contribution();
  });
  ...
  describe('Contribution', function() {
    it('should create an instance of Contribution', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.Contribution();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.Contribution);
    });
