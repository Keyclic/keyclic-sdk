...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.FeedbackReviewRequestLinks();
  });
  ...
  describe('FeedbackReviewRequestLinks', function() {
    it('should create an instance of FeedbackReviewRequestLinks', function() {
      // uncomment below and update the code to test FeedbackReviewRequestLinks
