...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PlaceLinksOrganization();
  });
  ...
  describe('PlaceLinksOrganization', function() {
    it('should create an instance of PlaceLinksOrganization', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.PlaceLinksOrganization();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.PlaceLinksOrganization);
    });
