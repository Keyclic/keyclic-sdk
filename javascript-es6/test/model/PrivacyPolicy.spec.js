...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PrivacyPolicy();
  });
  ...
  describe('PrivacyPolicy', function() {
    it('should create an instance of PrivacyPolicy', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.PrivacyPolicy();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.PrivacyPolicy);
    });
