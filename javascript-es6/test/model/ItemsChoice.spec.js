...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ItemsChoice();
  });
  ...
  describe('ItemsChoice', function() {
    it('should create an instance of ItemsChoice', function() {
      // uncomment below and update the code to test ItemsChoice
      //var instane = new @KeyclicSdkJavascript.ItemsChoice();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ItemsChoice);
    });
