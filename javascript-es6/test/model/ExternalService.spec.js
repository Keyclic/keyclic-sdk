...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ExternalService();
  });
  ...
  describe('ExternalService', function() {
    it('should create an instance of ExternalService', function() {
      // uncomment below and update the code to test ExternalService
      //var instane = new @KeyclicSdkJavascript.ExternalService();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ExternalService);
    });
