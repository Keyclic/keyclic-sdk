...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.FeedbackDataGeo();
  });
  ...
  describe('FeedbackDataGeo', function() {
    it('should create an instance of FeedbackDataGeo', function() {
      // uncomment below and update the code to test FeedbackDataGeo
      //var instane = new @KeyclicSdkJavascript.FeedbackDataGeo();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.FeedbackDataGeo);
    });
