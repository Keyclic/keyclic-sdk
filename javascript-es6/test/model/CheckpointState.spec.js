...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.CheckpointState();
  });
  ...
  describe('CheckpointState', function() {
    it('should create an instance of CheckpointState', function() {
      // uncomment below and update the code to test CheckpointState
      //var instane = new @KeyclicSdkJavascript.CheckpointState();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.CheckpointState);
    });
