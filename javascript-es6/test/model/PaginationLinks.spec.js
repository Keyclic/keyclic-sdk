...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PaginationLinks();
  });
  ...
  describe('PaginationLinks', function() {
    it('should create an instance of PaginationLinks', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.PaginationLinks();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.PaginationLinks);
    });
