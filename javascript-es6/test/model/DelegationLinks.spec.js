...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.DelegationLinks();
  });
  ...
  describe('DelegationLinks', function() {
    it('should create an instance of DelegationLinks', function() {
      // uncomment below and update the code to test DelegationLinks
