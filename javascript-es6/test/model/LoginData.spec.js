...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.LoginData();
  });
  ...
  describe('LoginData', function() {
    it('should create an instance of LoginData', function() {
      // uncomment below and update the code to test LoginData
      //var instane = new @KeyclicSdkJavascript.LoginData();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.LoginData);
    });
