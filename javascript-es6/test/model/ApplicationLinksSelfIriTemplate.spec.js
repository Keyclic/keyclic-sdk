...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ApplicationLinksSelfIriTemplate();
  });
  ...
  describe('ApplicationLinksSelfIriTemplate', function() {
    it('should create an instance of ApplicationLinksSelfIriTemplate', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.ApplicationLinksSelfIriTemplate();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ApplicationLinksSelfIriTemplate);
    });
