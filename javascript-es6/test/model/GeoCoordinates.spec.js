...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.GeoCoordinates();
  });
  ...
  describe('GeoCoordinates', function() {
    it('should create an instance of GeoCoordinates', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.GeoCoordinates();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.GeoCoordinates);
    });
