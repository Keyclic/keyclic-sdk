...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.OrganizationPatchPreferences();
  });
  ...
  describe('OrganizationPatchPreferences', function() {
    it('should create an instance of OrganizationPatchPreferences', function() {
      // uncomment below and update the code to test OrganizationPatchPreferences
