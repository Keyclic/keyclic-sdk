...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ReportTypeWorkflow();
  });
  ...
  describe('ReportTypeWorkflow', function() {
    it('should create an instance of ReportTypeWorkflow', function() {
      // uncomment below and update the code to test ReportTypeWorkflow
      //var instane = new @KeyclicSdkJavascript.ReportTypeWorkflow();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ReportTypeWorkflow);
    });
