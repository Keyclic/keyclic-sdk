...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ReviewData();
  });
  ...
  describe('ReviewData', function() {
    it('should create an instance of ReviewData', function() {
      // uncomment below and update the code to test ReviewData
      //var instane = new @KeyclicSdkJavascript.ReviewData();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ReviewData);
    });
