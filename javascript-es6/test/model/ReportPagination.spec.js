...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ReportPagination();
  });
  ...
  describe('ReportPagination', function() {
    it('should create an instance of ReportPagination', function() {
      // uncomment below and update the code to test ReportPagination
      //var instane = new @KeyclicSdkJavascript.ReportPagination();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ReportPagination);
    });
