...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.FollowingPagination();
  });
  ...
  describe('FollowingPagination', function() {
    it('should create an instance of FollowingPagination', function() {
      // uncomment below and update the code to test FollowingPagination
      //var instane = new @KeyclicSdkJavascript.FollowingPagination();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.FollowingPagination);
    });
