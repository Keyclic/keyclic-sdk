...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.DeviceLinks();
  });
  ...
  describe('DeviceLinks', function() {
    it('should create an instance of DeviceLinks', function() {
      // uncomment below and update the code to test DeviceLinks
      //var instane = new @KeyclicSdkJavascript.DeviceLinks();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.DeviceLinks);
    });
