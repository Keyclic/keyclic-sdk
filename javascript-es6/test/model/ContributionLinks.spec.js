...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ContributionLinks();
  });
  ...
  describe('ContributionLinks', function() {
    it('should create an instance of ContributionLinks', function() {
      // uncomment below and update the code to test ContributionLinks
      //var instane = new @KeyclicSdkJavascript.ContributionLinks();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ContributionLinks);
    });
