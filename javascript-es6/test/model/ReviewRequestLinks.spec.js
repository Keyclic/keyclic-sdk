...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ReviewRequestLinks();
  });
  ...
  describe('ReviewRequestLinks', function() {
    it('should create an instance of ReviewRequestLinks', function() {
      // uncomment below and update the code to test ReviewRequestLinks
      //var instane = new @KeyclicSdkJavascript.ReviewRequestLinks();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ReviewRequestLinks);
    });
