...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.DocumentPagination();
  });
  ...
  describe('DocumentPagination', function() {
    it('should create an instance of DocumentPagination', function() {
      // uncomment below and update the code to test DocumentPagination
