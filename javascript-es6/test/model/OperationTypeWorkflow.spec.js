...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.OperationTypeWorkflow();
  });
  ...
  describe('OperationTypeWorkflow', function() {
    it('should create an instance of OperationTypeWorkflow', function() {
      // uncomment below and update the code to test OperationTypeWorkflow
      //var instane = new @KeyclicSdkJavascript.OperationTypeWorkflow();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.OperationTypeWorkflow);
    });
