...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.LogEntryPagination();
  });
  ...
  describe('LogEntryPagination', function() {
    it('should create an instance of LogEntryPagination', function() {
      // uncomment below and update the code to test LogEntryPagination
      //var instane = new @KeyclicSdkJavascript.LogEntryPagination();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.LogEntryPagination);
    });
