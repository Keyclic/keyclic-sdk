...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.WebhookPatch();
  });
  ...
  describe('WebhookPatch', function() {
    it('should create an instance of WebhookPatch', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.WebhookPatch();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.WebhookPatch);
    });
