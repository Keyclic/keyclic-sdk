...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.SuccessLogin();
  });
  ...
  describe('SuccessLogin', function() {
    it('should create an instance of SuccessLogin', function() {
      // uncomment below and update the code to test SuccessLogin
      //var instane = new @KeyclicSdkJavascript.SuccessLogin();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.SuccessLogin);
    });
