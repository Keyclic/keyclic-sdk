...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.WorkflowTransition();
  });
  ...
  describe('WorkflowTransition', function() {
    it('should create an instance of WorkflowTransition', function() {
      // uncomment below and update the code to test WorkflowTransition
      //var instane = new @KeyclicSdkJavascript.WorkflowTransition();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.WorkflowTransition);
    });
