...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.SignatureSigner();
  });
  ...
  describe('SignatureSigner', function() {
    it('should create an instance of SignatureSigner', function() {
      // uncomment below and update the code to test SignatureSigner
      //var instane = new @KeyclicSdkJavascript.SignatureSigner();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.SignatureSigner);
    });
