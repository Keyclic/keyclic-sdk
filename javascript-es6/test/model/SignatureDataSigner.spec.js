...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.SignatureDataSigner();
  });
  ...
  describe('SignatureDataSigner', function() {
    it('should create an instance of SignatureDataSigner', function() {
      // uncomment below and update the code to test SignatureDataSigner
      //var instane = new @KeyclicSdkJavascript.SignatureDataSigner();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.SignatureDataSigner);
    });
