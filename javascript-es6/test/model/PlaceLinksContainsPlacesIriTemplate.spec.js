...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PlaceLinksContainsPlacesIriTemplate();
  });
  ...
  describe('PlaceLinksContainsPlacesIriTemplate', function() {
    it('should create an instance of PlaceLinksContainsPlacesIriTemplate', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.PlaceLinksContainsPlacesIriTemplate();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.PlaceLinksContainsPlacesIriTemplate);
    });
