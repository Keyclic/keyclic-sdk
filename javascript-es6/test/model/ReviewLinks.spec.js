...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ReviewLinks();
  });
  ...
  describe('ReviewLinks', function() {
    it('should create an instance of ReviewLinks', function() {
      // uncomment below and update the code to test ReviewLinks
