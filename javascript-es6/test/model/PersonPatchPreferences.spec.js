...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.PersonPatchPreferences();
  });
  ...
  describe('PersonPatchPreferences', function() {
    it('should create an instance of PersonPatchPreferences', function() {
      // uncomment below and update the code to test PersonPatchPreferences
