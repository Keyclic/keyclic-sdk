...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ActivityPagination();
  });
  ...
  describe('ActivityPagination', function() {
    it('should create an instance of ActivityPagination', function() {
      // uncomment below and update the code to test ActivityPagination
      //var instane = new @KeyclicSdkJavascript.ActivityPagination();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.ActivityPagination);
    });
