...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.DocumentData();
  });
  ...
  describe('DocumentData', function() {
    it('should create an instance of DocumentData', function() {
      ...
      //var instane = new @KeyclicSdkJavascript.DocumentData();
      //expect(instance).to.be.a(@KeyclicSdkJavascript.DocumentData);
    });
