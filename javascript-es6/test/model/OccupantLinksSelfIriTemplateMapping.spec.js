...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.OccupantLinksSelfIriTemplateMapping();
  });
  ...
  describe('OccupantLinksSelfIriTemplateMapping', function() {
    it('should create an instance of OccupantLinksSelfIriTemplateMapping', function() {
      // uncomment below and update the code to test OccupantLinksSelfIriTemplateMapping
