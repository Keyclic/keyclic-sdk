...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @KeyclicSdkJavascript.ExportApi();
  });
  ...
  describe('ExportApi', function() {
    ...
    describe('getExportByOrganizationAndToken', function() {
      it('should call getExportByOrganizationAndToken successfully', function(done) {
        //uncomment below and update the code to test getExportByOrganizationAndToken
        //instance.getExportByOrganizationAndToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
