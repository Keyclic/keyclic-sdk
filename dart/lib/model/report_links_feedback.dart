...
class ReportLinksFeedback {
  ...
  static List<ReportLinksFeedback> listFromJson(List<dynamic> json) {
    return json == null ? List<ReportLinksFeedback>() : json.map((value) => ReportLinksFeedback.fromJson(value)).toList();
  }

  static Map<String, ReportLinksFeedback> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, ReportLinksFeedback>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = ReportLinksFeedback.fromJson(value));
    }
    return map;
  }
}
