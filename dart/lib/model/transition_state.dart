...
class TransitionState {
  ...
  @override
  String toString() {
    return 'TransitionState[allowAdd=$allowAdd, allowDispatch=$allowDispatch, color=$color, description=$description, end=$end, id=$id, key=$key, name=$name, progression=$progression, type=$type, ]';
  }
}
