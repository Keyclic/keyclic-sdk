...
class PublicationCollection {
  ...
  static List<PublicationCollection> listFromJson(List<dynamic> json) {
    return json == null ? List<PublicationCollection>() : json.map((value) => PublicationCollection.fromJson(value)).toList();
  }

  static Map<String, PublicationCollection> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, PublicationCollection>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = PublicationCollection.fromJson(value));
    }
    return map;
  }
}
