...
class CategoryLinksOrganization {
  ...
  static List<CategoryLinksOrganization> listFromJson(List<dynamic> json) {
    return json == null ? List<CategoryLinksOrganization>() : json.map((value) => CategoryLinksOrganization.fromJson(value)).toList();
  }

  static Map<String, CategoryLinksOrganization> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, CategoryLinksOrganization>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = CategoryLinksOrganization.fromJson(value));
    }
    return map;
  }
}
