...
class PlaceTypeWorkflow {
  ...
  factory PlaceTypeWorkflow.fromJson(Map<String, dynamic> json) {
    if (json == null) {
      return null;
    }
  ...
  static List<PlaceTypeWorkflow> listFromJson(List<dynamic> json) {
    return json
            ?.map((dynamic value) => PlaceTypeWorkflow.fromJson(value))
            ?.toList() ??
        <PlaceTypeWorkflow>[];
  }

  static Map<String, PlaceTypeWorkflow> mapFromJson(Map<String, dynamic> json) {
    return json?.map<String, PlaceTypeWorkflow>((String key, dynamic value) {
          return MapEntry(key, PlaceTypeWorkflow.fromJson(value));
        }) ??
        <String, PlaceTypeWorkflow>{};
  }
  ...
  @override
  String toString() {
    return 'PlaceTypeWorkflow[createdAt=$createdAt, description=$description, end=$end, id=$id, name=$name, start=$start, states=$states, transitions=$transitions, type=$type, updatedAt=$updatedAt, ]';
  }
}
