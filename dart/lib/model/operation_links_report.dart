...
class OperationLinksReport {
  ...
  static List<OperationLinksReport> listFromJson(List<dynamic> json) {
    return json == null ? List<OperationLinksReport>() : json.map((value) => OperationLinksReport.fromJson(value)).toList();
  }

  static Map<String, OperationLinksReport> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, OperationLinksReport>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = OperationLinksReport.fromJson(value));
    }
    return map;
  }
}
