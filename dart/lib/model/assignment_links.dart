...
class AssignmentLinks {
  ...
  factory AssignmentLinks.fromJson(Map<String, dynamic> json) {
    ...
    return AssignmentLinks(
      createdBy: AssignmentLinksCreatedBy.fromJson(json['createdBy']),
  ...
  AssignmentLinksCreatedBy createdBy;
  ...
  @override
  String toString() {
    return 'AssignmentLinks[createdBy=$createdBy, report=$report, self=$self, service=$service, ]';
  }
}
