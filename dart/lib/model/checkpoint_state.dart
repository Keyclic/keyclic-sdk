...
class CheckpointState {
  ...
  @override
  String toString() {
    return 'CheckpointState[allowAdd=$allowAdd, allowDispatch=$allowDispatch, color=$color, description=$description, id=$id, name=$name, progression=$progression, type=$type, ]';
  }
}
