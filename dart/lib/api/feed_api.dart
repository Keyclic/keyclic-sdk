...
class FeedApi {
  ...
  ///
  ///
  Future<ActivityAggregatedPagination> cgetFeedsByFeed(String xKeyclicApp, String feed, {String acceptLanguage, String xKeyclicAppVersion, int page, int limit, String order, DateTime after, DateTime before}) async {
    Object postBody;
    ...
    String path = "/feeds/{feed}".replaceAll("{format}", "json").replaceAll("{" + "feed" + "}", feed.toString());
