...
class AssignmentApi {
  ...
  ///
  ///
  Future<Assignment> getAssignment_1(
    String xKeyclicApp,
    String assignment, {
    String acceptLanguage,
    DateTime xDateTime,
    ...
    // create path and map variables
    final String path = "/delegations/{assignment}"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "assignment" + "}", assignment.toString());
  ...
  ///
  ///
  Future<Assignment> postAssignment_2(
    String xKeyclicApp,
    AssignmentData assignmentData, {
    String acceptLanguage,
    DateTime xDateTime,
  ...
  ///
  ///
  Future<Assignment> postWorkflowByAssignment(
    String xKeyclicApp,
    ...
    // create path and map variables
    final String path = "/assignments/{assignment}/workflow"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "assignment" + "}", assignment.toString());
  ...
  ///
  ///
  Future<Assignment> postWorkflowByAssignment_3(
    String xKeyclicApp,
    WorkflowData workflowData,
    String assignment, {
    String acceptLanguage,
    ...
    // create path and map variables
    final String path = "/delegations/{assignment}/workflow"
        .replaceAll("{format}", "json")
        .replaceAll("{" + "assignment" + "}", assignment.toString());
