...
class ServiceApi {
  ...
  ///
  ///
  Future<ServicePagination> cgetServicesByOrganization(String xKeyclicApp, String organization, {String acceptLanguage, String xKeyclicAppVersion, int page, int limit, String order, DateTime after, DateTime before}) async {
    Object postBody;
    ...
    String path = "/organizations/{organization}/services".replaceAll("{format}", "json").replaceAll("{" + "organization" + "}", organization.toString());
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'ServicePagination') as ServicePagination;
    } else {
      return null;
    }
  }
