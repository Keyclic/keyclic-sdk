...
class FileApi {
  ...
  ///
  ///
  Future<MultipartFile> getFileByDocument(String xKeyclicApp, String document, {String acceptLanguage, String xKeyclicAppVersion}) async {
    Object postBody;
    ...
    String path = "/documents/{document}/file".replaceAll("{format}", "json").replaceAll("{" + "document" + "}", document.toString());
