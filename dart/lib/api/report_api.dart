...
class ReportApi {
  ...
  ///
  ///
  Future<ReportPagination> cgetReportsByOrganization(String xKeyclicApp, String organization,
      {String acceptLanguage, String xKeyclicAppVersion, String state, String place, String category, String delegatedTo, String assignedTo, String query, int page, int limit, String order, DateTime after, DateTime before}) async {
    Object postBody;
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'ReportPagination') as ReportPagination;
    } else {
      return null;
    }
  }
