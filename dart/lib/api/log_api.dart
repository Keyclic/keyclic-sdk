...
class LogApi {
  ...
  ///
  ///
  Future<LogEntryPagination> cgetLogsByOperation(String xKeyclicApp, String operation, {String acceptLanguage, String xKeyclicAppVersion, int page, int limit, String order, DateTime after, DateTime before}) async {
    Object postBody;
    ...
    String path = "/operations/{operation}/logs".replaceAll("{format}", "json").replaceAll("{" + "operation" + "}", operation.toString());
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'LogEntryPagination') as LogEntryPagination;
    } else {
      return null;
    }
  }
