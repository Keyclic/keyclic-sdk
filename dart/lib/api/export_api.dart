...
class ExportApi {
  ...
  ///
  ///
  Future<Report> cpostExportByOrganization(String xKeyclicApp, String organization,
      {String acceptLanguage, String xKeyclicAppVersion, String place, String state, String category, String delegatedTo, String assignedTo, String query, int page, int limit, String order, DateTime after, DateTime before}) async {
    Object postBody;
