...
class ContributionApi {
  ...
  ///
  ///
  Future<ActivityAggregatedPagination> cgetContributionsByFeedback(String xKeyclicApp, String feedback, {String acceptLanguage, String xKeyclicAppVersion, int page, int limit, String order, DateTime after, DateTime before}) async {
    Object postBody;
    ...
    String path = "/feedbacks/{feedback}/contributions".replaceAll("{format}", "json").replaceAll("{" + "feedback" + "}", feedback.toString());
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'ActivityAggregatedPagination') as ActivityAggregatedPagination;
    } else {
      return null;
    }
  }
  ...
  ///
  ///
  Future<Operation> postContributionByFeedback(String xKeyclicApp, String feedback, {String acceptLanguage, String xKeyclicAppVersion}) async {
    Object postBody;
