...
class MembershipApi {
  ...
  ///
  ///
  Future<MemberPagination> cgetMembershipsByPerson(String xKeyclicApp, String person,
    ...
    String path = "/people/{person}/memberships".replaceAll("{format}", "json").replaceAll("{" + "person" + "}", person.toString());
