...
------------- | ------------- | -------------
[**cgetDocumentsByReport**](DocumentApi.md#cgetDocumentsByReport) | **GET** /reports/{report}/documents | Retrieve all Document resources.
...
[**postDocumentByReport**](DocumentApi.md#postDocumentByReport) | **POST** /reports/{report}/documents | Create one Document resource.
...
try { 
    ...
    print("Exception when calling DocumentApi->postDocumentByReport: $e\n");
}
```
