...
> WebhookPagination cgetWebhooksByOrganization(xKeyclicApp, organization, acceptLanguage, xKeyclicAppVersion, page, limit, order, after, before)
...
try { 
    var result = api_instance.cgetWebhooksByOrganization(xKeyclicApp, organization, acceptLanguage, xKeyclicAppVersion, page, limit, order, after, before);
    print(result);
} catch (e) {
