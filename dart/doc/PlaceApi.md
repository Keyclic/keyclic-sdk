...
# **postPlace**
> Place postPlace(xKeyclicApp, placeData, acceptLanguage, xKeyclicAppVersion)
...
try { 
    var result = api_instance.postPlace(xKeyclicApp, placeData, acceptLanguage, xKeyclicAppVersion);
    print(result);
} catch (e) {
