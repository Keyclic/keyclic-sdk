# keyclic_sdk_api.api.TrackingApi
...
try { 
    ...
    print("Exception when calling TrackingApi->getTrackingByFeedback: $e\n");
}
```
...
> Tracking getTrackingByOperation(xKeyclicApp, operation, acceptLanguage, xKeyclicAppVersion)
...
try { 
    var result = api_instance.getTrackingByOperation(xKeyclicApp, operation, acceptLanguage, xKeyclicAppVersion);
    print(result);
} catch (e) {
    print("Exception when calling TrackingApi->getTrackingByOperation: $e\n");
}
```
...
try { 
    ...
    print("Exception when calling TrackingApi->getTrackingByReport: $e\n");
}
```
