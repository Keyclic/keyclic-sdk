...
> ServicePagination cgetServicesByOrganization(xKeyclicApp, organization, acceptLanguage, xKeyclicAppVersion, after, before, order, page, limit)
...
try { 
    var result = api_instance.cgetServicesByOrganization(xKeyclicApp, organization, acceptLanguage, xKeyclicAppVersion, after, before, order, page, limit);
    print(result);
} catch (e) {
