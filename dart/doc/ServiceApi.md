...
# **getService**
> Service getService(xKeyclicApp, service, acceptLanguage, xDateTime, xKeyclicAppVersion)
...
try { 
    var result = api_instance.getService(xKeyclicApp, service, acceptLanguage, xDateTime, xKeyclicAppVersion);
    print(result);
} catch (e) {
