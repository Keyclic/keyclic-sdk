# keyclic_sdk_api.api.DelegationApi
...
var delegation = ; // String | The identifier of the resource formatted as GUID string.
 ...
 **delegation** | [**String**](.md)| The identifier of the resource formatted as GUID string. | 
