...
export default class PersonLinksImage {
    /**
     * Constructs a new <code>PersonLinksImage</code>.
    ...
    /**
    * Constructs a <code>PersonLinksImage</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PersonLinksImage} obj Optional instance to populate.
    * @return {module:model/PersonLinksImage} The populated <code>PersonLinksImage</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonLinksImage();
