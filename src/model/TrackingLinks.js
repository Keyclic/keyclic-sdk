...
import TrackingLinksOrganization from './TrackingLinksOrganization';


    

/**
 * The TrackingLinks model module.
 * @module model/TrackingLinks
 * @version 1.12.1
 */
export default class TrackingLinks {
    /**
     * Constructs a new <code>TrackingLinks</code>.
     * Links to browse automatically API
     * @alias module:model/TrackingLinks
     * @class
    ...
    /**
    * Constructs a <code>TrackingLinks</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TrackingLinks} obj Optional instance to populate.
    * @return {module:model/TrackingLinks} The populated <code>TrackingLinks</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackingLinks();

            


            if (data.hasOwnProperty('organization')) {
                obj['organization'] = TrackingLinksOrganization.constructFromObject(data['organization']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/TrackingLinksOrganization} organization
     */
