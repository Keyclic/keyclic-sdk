...
export default class PlaceLinksSelfIriTemplateMapping {
    /**
     * Constructs a new <code>PlaceLinksSelfIriTemplateMapping</code>.
    ...
    /**
    * Constructs a <code>PlaceLinksSelfIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PlaceLinksSelfIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/PlaceLinksSelfIriTemplateMapping} The populated <code>PlaceLinksSelfIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaceLinksSelfIriTemplateMapping();
