...
export default class OperationLinksSelfIriTemplateMapping {
    /**
     * Constructs a new <code>OperationLinksSelfIriTemplateMapping</code>.
    ...
    /**
    * Constructs a <code>OperationLinksSelfIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationLinksSelfIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/OperationLinksSelfIriTemplateMapping} The populated <code>OperationLinksSelfIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationLinksSelfIriTemplateMapping();
