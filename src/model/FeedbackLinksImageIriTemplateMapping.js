...
export default class FeedbackLinksImageIriTemplateMapping {
    /**
     * Constructs a new <code>FeedbackLinksImageIriTemplateMapping</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksImageIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksImageIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksImageIriTemplateMapping} The populated <code>FeedbackLinksImageIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksImageIriTemplateMapping();
