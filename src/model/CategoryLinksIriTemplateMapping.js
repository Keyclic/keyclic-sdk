...
/**
 * The CategoryLinksIriTemplateMapping model module.
 * @module model/CategoryLinksIriTemplateMapping
 * @version 1.12.1
 */
export default class CategoryLinksIriTemplateMapping {
    /**
     * Constructs a new <code>CategoryLinksIriTemplateMapping</code>.
     * @alias module:model/CategoryLinksIriTemplateMapping
     * @class
    ...
    /**
    * Constructs a <code>CategoryLinksIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryLinksIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/CategoryLinksIriTemplateMapping} The populated <code>CategoryLinksIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryLinksIriTemplateMapping();
