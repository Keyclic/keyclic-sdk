...
/**
 * The OrganizationPaginationEmbedded model module.
 * @module model/OrganizationPaginationEmbedded
 * @version 1.12.1
 */
export default class OrganizationPaginationEmbedded {
    /**
     * Constructs a new <code>OrganizationPaginationEmbedded</code>.
     * 
     * @alias module:model/OrganizationPaginationEmbedded
     * @class
    ...
    /**
    * Constructs a <code>OrganizationPaginationEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrganizationPaginationEmbedded} obj Optional instance to populate.
    * @return {module:model/OrganizationPaginationEmbedded} The populated <code>OrganizationPaginationEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationPaginationEmbedded();

            


            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Organization]);
            }
        }
        return obj;
    }
    ...
    /**
     * 
     * @member {Array.<module:model/Organization>} items
     */
    items = undefined;
