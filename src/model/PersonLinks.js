...
export default class PersonLinks {
    /**
     * Constructs a new <code>PersonLinks</code>.
     * 
    ...
    /**
    * Constructs a <code>PersonLinks</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PersonLinks} obj Optional instance to populate.
    * @return {module:model/PersonLinks} The populated <code>PersonLinks</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonLinks();

            


            if (data.hasOwnProperty('self')) {
                obj['self'] = PersonLinksSelf.constructFromObject(data['self']);
            }
            if (data.hasOwnProperty('image')) {
                obj['image'] = PersonLinksImage.constructFromObject(data['image']);
            }
            if (data.hasOwnProperty('memberOf')) {
                obj['memberOf'] = CategoryLinksOrganization.constructFromObject(data['memberOf']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/PersonLinksSelf} self
     */
    self = undefined;
    /**
     * @member {module:model/PersonLinksImage} image
     */
    image = undefined;
    /**
     * @member {module:model/CategoryLinksOrganization} memberOf
     */
    memberOf = undefined;
