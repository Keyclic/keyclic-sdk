...
export default class ReportLinksSelf {
    /**
     * Constructs a new <code>ReportLinksSelf</code>.
    ...
    /**
    * Constructs a <code>ReportLinksSelf</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportLinksSelf} obj Optional instance to populate.
    * @return {module:model/ReportLinksSelf} The populated <code>ReportLinksSelf</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportLinksSelf();
