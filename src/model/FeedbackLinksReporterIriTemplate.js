 ...
 * @version 1.12.1
 */
export default class FeedbackLinksReporterIriTemplate {
    /**
     * Constructs a new <code>FeedbackLinksReporterIriTemplate</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksReporterIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksReporterIriTemplate} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksReporterIriTemplate} The populated <code>FeedbackLinksReporterIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksReporterIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = FeedbackLinksReporterIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/FeedbackLinksReporterIriTemplateMapping} mapping
     */
    mapping = undefined;
