...
export default class OrganizationLinks {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('self')) {
                obj['self'] = OrganizationLinksSelf.constructFromObject(data['self']);
            }
            if (data.hasOwnProperty('logo')) {
                obj['logo'] = OrganizationLinksLogo.constructFromObject(data['logo']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/OrganizationLinksSelf} self
     */
    self = undefined;
    /**
     * @member {module:model/OrganizationLinksLogo} logo
     */
    logo = undefined;
