...
/**
 * The DelegateBody model module.
 * @module model/DelegateBody
 * @version 1.12.1
 */
export default class DelegateBody {
    /**
     * Constructs a new <code>DelegateBody</code>.
     * The body to delegate a report to an organization.
     * @alias module:model/DelegateBody
     * @class
    ...
    /**
    * Constructs a <code>DelegateBody</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DelegateBody} obj Optional instance to populate.
    * @return {module:model/DelegateBody} The populated <code>DelegateBody</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DelegateBody();
    ...
    report = undefined;
    /**
     * The organition that receive the delegated report.
