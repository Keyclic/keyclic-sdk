...
import PersonPaginationEmbedded from './PersonPaginationEmbedded';
 ...
 * @version 1.12.1
 */
export default class PersonPagination {
    /**
     * Constructs a new <code>PersonPagination</code>.
     * A list of person formatted as HATEOAS paginated representation.
    ...
    /**
    * Constructs a <code>PersonPagination</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PersonPagination} obj Optional instance to populate.
    * @return {module:model/PersonPagination} The populated <code>PersonPagination</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonPagination();
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = PersonPaginationEmbedded.constructFromObject(data['_embedded']);
            }
        }
        return obj;
    }
    ...
    _links = undefined;
    /**
     * @member {module:model/PersonPaginationEmbedded} _embedded
     */
    _embedded = undefined;
