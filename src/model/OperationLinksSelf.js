...
export default class OperationLinksSelf {
    /**
     * Constructs a new <code>OperationLinksSelf</code>.
    ...
    /**
    * Constructs a <code>OperationLinksSelf</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationLinksSelf} obj Optional instance to populate.
    * @return {module:model/OperationLinksSelf} The populated <code>OperationLinksSelf</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationLinksSelf();
            ...
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = OperationLinksSelfIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * The URI of the current operation.
     * @member {String} href
     */
    href = undefined;
    /**
     * @member {module:model/OperationLinksSelfIriTemplate} iriTemplate
     */
