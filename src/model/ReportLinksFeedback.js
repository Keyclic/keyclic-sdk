...
export default class ReportLinksFeedback {
    /**
     * Constructs a new <code>ReportLinksFeedback</code>.
    ...
    /**
    * Constructs a <code>ReportLinksFeedback</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportLinksFeedback} obj Optional instance to populate.
    * @return {module:model/ReportLinksFeedback} The populated <code>ReportLinksFeedback</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportLinksFeedback();
            ...
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = FeedbackLinksSelfIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * The URI of the linked feedback.
     * @member {String} href
     */
    href = undefined;
    /**
     * @member {module:model/FeedbackLinksSelfIriTemplate} iriTemplate
     */
