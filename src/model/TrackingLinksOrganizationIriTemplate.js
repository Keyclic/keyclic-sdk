...
import TrackingLinksOrganizationIriTemplateMapping from './TrackingLinksOrganizationIriTemplateMapping';


    

/**
 * The TrackingLinksOrganizationIriTemplate model module.
 * @module model/TrackingLinksOrganizationIriTemplate
 * @version 1.12.1
 */
export default class TrackingLinksOrganizationIriTemplate {
    /**
     * Constructs a new <code>TrackingLinksOrganizationIriTemplate</code>.
     * @alias module:model/TrackingLinksOrganizationIriTemplate
     * @class
    ...
    /**
    * Constructs a <code>TrackingLinksOrganizationIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TrackingLinksOrganizationIriTemplate} obj Optional instance to populate.
    * @return {module:model/TrackingLinksOrganizationIriTemplate} The populated <code>TrackingLinksOrganizationIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackingLinksOrganizationIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = TrackingLinksOrganizationIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/TrackingLinksOrganizationIriTemplateMapping} mapping
     */
    mapping = undefined;
