...
export default class FeedbackLinksImage {
    /**
     * Constructs a new <code>FeedbackLinksImage</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksImage</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksImage} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksImage} The populated <code>FeedbackLinksImage</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksImage();
            ...
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = FeedbackLinksImageIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * The URI of the linked image.
     * @member {String} href
     */
    href = undefined;
    /**
     * @member {module:model/FeedbackLinksImageIriTemplate} iriTemplate
     */
