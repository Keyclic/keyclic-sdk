...
export default class CategoryLinks {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('self')) {
                obj['self'] = CategoryLinksSelf.constructFromObject(data['self']);
            }
            if (data.hasOwnProperty('organization')) {
                obj['organization'] = ApiClient.convertToType(data['organization'], [CategoryLinksOrganization]);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/CategoryLinksSelf} self
     */
    self = undefined;
    /**
     * @member {Array.<module:model/CategoryLinksOrganization>} organization
     */
