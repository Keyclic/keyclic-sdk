...
import TrackingLinksOrganizationIriTemplate from './TrackingLinksOrganizationIriTemplate';


    

/**
 * The TrackingLinksOrganization model module.
 * @module model/TrackingLinksOrganization
 * @version 1.12.1
 */
export default class TrackingLinksOrganization {
    /**
     * Constructs a new <code>TrackingLinksOrganization</code>.
     * @alias module:model/TrackingLinksOrganization
     * @class
    ...
    /**
    * Constructs a <code>TrackingLinksOrganization</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TrackingLinksOrganization} obj Optional instance to populate.
    * @return {module:model/TrackingLinksOrganization} The populated <code>TrackingLinksOrganization</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackingLinksOrganization();
            ...
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = TrackingLinksOrganizationIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * The URI of the current organization.
     * @member {String} href
     */
    href = undefined;
    /**
     * @member {module:model/TrackingLinksOrganizationIriTemplate} iriTemplate
     */
