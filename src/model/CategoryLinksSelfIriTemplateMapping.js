...
export default class CategoryLinksSelfIriTemplateMapping {
    /**
     * Constructs a new <code>CategoryLinksSelfIriTemplateMapping</code>.
    ...
    /**
    * Constructs a <code>CategoryLinksSelfIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryLinksSelfIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/CategoryLinksSelfIriTemplateMapping} The populated <code>CategoryLinksSelfIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryLinksSelfIriTemplateMapping();
