...
import ApplicationLinksIriTemplateMapping from './ApplicationLinksIriTemplateMapping';


    

/**
 * The ApplicationLinksIriTemplate model module.
 * @module model/ApplicationLinksIriTemplate
 * @version 1.12.1
 */
export default class ApplicationLinksIriTemplate {
    /**
     * Constructs a new <code>ApplicationLinksIriTemplate</code>.
     * @alias module:model/ApplicationLinksIriTemplate
     * @class
    ...
    /**
    * Constructs a <code>ApplicationLinksIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ApplicationLinksIriTemplate} obj Optional instance to populate.
    * @return {module:model/ApplicationLinksIriTemplate} The populated <code>ApplicationLinksIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationLinksIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = ApplicationLinksIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/ApplicationLinksIriTemplateMapping} mapping
     */
    mapping = undefined;
