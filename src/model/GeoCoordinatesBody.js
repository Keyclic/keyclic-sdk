...
/**
 * The GeoCoordinatesBody model module.
 * @module model/GeoCoordinatesBody
 * @version 1.12.1
 */
export default class GeoCoordinatesBody {
    /**
     * Constructs a new <code>GeoCoordinatesBody</code>.
     * 
     * @alias module:model/GeoCoordinatesBody
     * @class
    ...
    /**
    * Constructs a <code>GeoCoordinatesBody</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GeoCoordinatesBody} obj Optional instance to populate.
    * @return {module:model/GeoCoordinatesBody} The populated <code>GeoCoordinatesBody</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeoCoordinatesBody();
