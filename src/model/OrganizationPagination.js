...
import OrganizationPaginationEmbedded from './OrganizationPaginationEmbedded';
 ...
 * @version 1.12.1
 */
export default class OrganizationPagination {
    /**
     * Constructs a new <code>OrganizationPagination</code>.
     * A list of organizations formatted as HATEOAS paginated representation.
    ...
    /**
    * Constructs a <code>OrganizationPagination</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrganizationPagination} obj Optional instance to populate.
    * @return {module:model/OrganizationPagination} The populated <code>OrganizationPagination</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationPagination();
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = OrganizationPaginationEmbedded.constructFromObject(data['_embedded']);
            }
        }
        return obj;
    }
    ...
    _links = undefined;
    /**
     * @member {module:model/OrganizationPaginationEmbedded} _embedded
     */
    _embedded = undefined;
