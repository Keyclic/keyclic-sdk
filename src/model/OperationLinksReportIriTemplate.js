...
export default class OperationLinksReportIriTemplate {
    /**
     * Constructs a new <code>OperationLinksReportIriTemplate</code>.
    ...
    /**
    * Constructs a <code>OperationLinksReportIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationLinksReportIriTemplate} obj Optional instance to populate.
    * @return {module:model/OperationLinksReportIriTemplate} The populated <code>OperationLinksReportIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationLinksReportIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = OperationLinksReportIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/OperationLinksReportIriTemplateMapping} mapping
     */
    mapping = undefined;
