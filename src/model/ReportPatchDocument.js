...
/**
 * The ReportPatchDocument model module.
 * @module model/ReportPatchDocument
 * @version 1.12.1
 */
export default class ReportPatchDocument {
    /**
     * Constructs a new <code>ReportPatchDocument</code>.
     * @alias module:model/ReportPatchDocument
     * @class
    
     * @param op {module:model/ReportPatchDocument.OpEnum} The operation to be performed.
     * @param path {module:model/ReportPatchDocument.PathEnum} A JSON-Pointer.
     * @param value {String} 
     */
    constructor(
    op, 
    ...
    /**
    * Constructs a <code>ReportPatchDocument</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportPatchDocument} obj Optional instance to populate.
    * @return {module:model/ReportPatchDocument} The populated <code>ReportPatchDocument</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportPatchDocument();
     ...
     * @member {module:model/ReportPatchDocument.OpEnum} op
     */
    op = undefined;
    /**
     * A JSON-Pointer.
     * @member {module:model/ReportPatchDocument.PathEnum} path
     */
    path = undefined;
    /**
     * 
