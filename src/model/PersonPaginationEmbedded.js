...
/**
 * The PersonPaginationEmbedded model module.
 * @module model/PersonPaginationEmbedded
 * @version 1.12.1
 */
export default class PersonPaginationEmbedded {
    /**
     * Constructs a new <code>PersonPaginationEmbedded</code>.
     * 
     * @alias module:model/PersonPaginationEmbedded
     * @class
    ...
    /**
    * Constructs a <code>PersonPaginationEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PersonPaginationEmbedded} obj Optional instance to populate.
    * @return {module:model/PersonPaginationEmbedded} The populated <code>PersonPaginationEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonPaginationEmbedded();
