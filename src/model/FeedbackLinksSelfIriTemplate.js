...
export default class FeedbackLinksSelfIriTemplate {
    /**
     * Constructs a new <code>FeedbackLinksSelfIriTemplate</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksSelfIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksSelfIriTemplate} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksSelfIriTemplate} The populated <code>FeedbackLinksSelfIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksSelfIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = FeedbackLinksSelfIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/FeedbackLinksSelfIriTemplateMapping} mapping
     */
    mapping = undefined;
