...
export default class OperationLinks {
    /**
     * Constructs a new <code>OperationLinks</code>.
     * 
    ...
    /**
    * Constructs a <code>OperationLinks</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationLinks} obj Optional instance to populate.
    * @return {module:model/OperationLinks} The populated <code>OperationLinks</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationLinks();

            


            if (data.hasOwnProperty('self')) {
                obj['self'] = OperationLinksSelf.constructFromObject(data['self']);
            }
            if (data.hasOwnProperty('operator')) {
                obj['operator'] = FeedbackLinksReporter.constructFromObject(data['operator']);
            }
            if (data.hasOwnProperty('report')) {
                obj['report'] = OperationLinksReport.constructFromObject(data['report']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/OperationLinksSelf} self
     */
    self = undefined;
    /**
     * @member {module:model/FeedbackLinksReporter} operator
     */
    operator = undefined;
    /**
     * @member {module:model/OperationLinksReport} report
     */
    report = undefined;
