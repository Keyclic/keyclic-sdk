...
export default class FeedbackLinksReporterIriTemplateMapping {
    /**
     * Constructs a new <code>FeedbackLinksReporterIriTemplateMapping</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksReporterIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksReporterIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksReporterIriTemplateMapping} The populated <code>FeedbackLinksReporterIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksReporterIriTemplateMapping();
