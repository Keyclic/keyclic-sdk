...
/**
 * The TrackingLinksOrganizationIriTemplateMapping model module.
 * @module model/TrackingLinksOrganizationIriTemplateMapping
 * @version 1.12.1
 */
export default class TrackingLinksOrganizationIriTemplateMapping {
    /**
     * Constructs a new <code>TrackingLinksOrganizationIriTemplateMapping</code>.
     * @alias module:model/TrackingLinksOrganizationIriTemplateMapping
     * @class
    ...
    /**
    * Constructs a <code>TrackingLinksOrganizationIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TrackingLinksOrganizationIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/TrackingLinksOrganizationIriTemplateMapping} The populated <code>TrackingLinksOrganizationIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackingLinksOrganizationIriTemplateMapping();
