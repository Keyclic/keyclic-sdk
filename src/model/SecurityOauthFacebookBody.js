...
/**
 * The SecurityOauthFacebookBody model module.
 * @module model/SecurityOauthFacebookBody
 * @version 1.12.1
 */
export default class SecurityOauthFacebookBody {
    /**
     * Constructs a new <code>SecurityOauthFacebookBody</code>.
     * 
     * @alias module:model/SecurityOauthFacebookBody
     * @class
    ...
    /**
    * Constructs a <code>SecurityOauthFacebookBody</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SecurityOauthFacebookBody} obj Optional instance to populate.
    * @return {module:model/SecurityOauthFacebookBody} The populated <code>SecurityOauthFacebookBody</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SecurityOauthFacebookBody();
