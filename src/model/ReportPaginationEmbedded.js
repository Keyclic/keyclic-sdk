...
/**
 * The ReportPaginationEmbedded model module.
 * @module model/ReportPaginationEmbedded
 * @version 1.12.1
 */
export default class ReportPaginationEmbedded {
    /**
     * Constructs a new <code>ReportPaginationEmbedded</code>.
     * 
     * @alias module:model/ReportPaginationEmbedded
     * @class
    ...
    /**
    * Constructs a <code>ReportPaginationEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportPaginationEmbedded} obj Optional instance to populate.
    * @return {module:model/ReportPaginationEmbedded} The populated <code>ReportPaginationEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportPaginationEmbedded();
