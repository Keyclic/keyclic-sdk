...
import CategoryLinksIriTemplateMapping from './CategoryLinksIriTemplateMapping';


    

/**
 * The CategoryLinksIriTemplate model module.
 * @module model/CategoryLinksIriTemplate
 * @version 1.12.1
 */
export default class CategoryLinksIriTemplate {
    /**
     * Constructs a new <code>CategoryLinksIriTemplate</code>.
     * @alias module:model/CategoryLinksIriTemplate
     * @class
    ...
    /**
    * Constructs a <code>CategoryLinksIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryLinksIriTemplate} obj Optional instance to populate.
    * @return {module:model/CategoryLinksIriTemplate} The populated <code>CategoryLinksIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryLinksIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = CategoryLinksIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/CategoryLinksIriTemplateMapping} mapping
     */
    mapping = undefined;
