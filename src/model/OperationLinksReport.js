...
export default class OperationLinksReport {
    /**
     * Constructs a new <code>OperationLinksReport</code>.
    ...
    /**
    * Constructs a <code>OperationLinksReport</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationLinksReport} obj Optional instance to populate.
    * @return {module:model/OperationLinksReport} The populated <code>OperationLinksReport</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationLinksReport();
