...
import OperationPaginationEmbedded from './OperationPaginationEmbedded';
 ...
 * @version 1.12.1
 */
export default class OperationPagination {
    /**
     * Constructs a new <code>OperationPagination</code>.
     * A list of operations formatted as HATEOAS paginated representation.
    ...
    /**
    * Constructs a <code>OperationPagination</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationPagination} obj Optional instance to populate.
    * @return {module:model/OperationPagination} The populated <code>OperationPagination</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationPagination();
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = OperationPaginationEmbedded.constructFromObject(data['_embedded']);
            }
        }
        return obj;
    }
    ...
    _links = undefined;
    /**
     * @member {module:model/OperationPaginationEmbedded} _embedded
     */
    _embedded = undefined;
