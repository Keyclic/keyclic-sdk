...
export default class PersonLinksSelf {
    /**
     * Constructs a new <code>PersonLinksSelf</code>.
    ...
    /**
    * Constructs a <code>PersonLinksSelf</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PersonLinksSelf} obj Optional instance to populate.
    * @return {module:model/PersonLinksSelf} The populated <code>PersonLinksSelf</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonLinksSelf();
