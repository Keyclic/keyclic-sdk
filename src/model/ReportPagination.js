...
import ReportPaginationEmbedded from './ReportPaginationEmbedded';
 ...
 * @version 1.12.1
 */
export default class ReportPagination {
    /**
     * Constructs a new <code>ReportPagination</code>.
     * A list of reports formatted as HATEOAS paginated representation.
    ...
    /**
    * Constructs a <code>ReportPagination</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportPagination} obj Optional instance to populate.
    * @return {module:model/ReportPagination} The populated <code>ReportPagination</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportPagination();
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = ReportPaginationEmbedded.constructFromObject(data['_embedded']);
            }
        }
        return obj;
    }
    ...
    _links = undefined;
    /**
     * @member {module:model/ReportPaginationEmbedded} _embedded
     */
    _embedded = undefined;
