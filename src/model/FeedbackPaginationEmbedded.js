...
/**
 * The FeedbackPaginationEmbedded model module.
 * @module model/FeedbackPaginationEmbedded
 * @version 1.12.1
 */
export default class FeedbackPaginationEmbedded {
    /**
     * Constructs a new <code>FeedbackPaginationEmbedded</code>.
     * 
     * @alias module:model/FeedbackPaginationEmbedded
     * @class
    ...
    /**
    * Constructs a <code>FeedbackPaginationEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackPaginationEmbedded} obj Optional instance to populate.
    * @return {module:model/FeedbackPaginationEmbedded} The populated <code>FeedbackPaginationEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackPaginationEmbedded();

            


            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Feedback]);
            }
        }
        return obj;
    }
    ...
    /**
     * 
     * @member {Array.<module:model/Feedback>} items
     */
    items = undefined;
