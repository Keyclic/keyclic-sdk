...
export default class ErrorEmbedded {
    /**
     * Constructs a new <code>ErrorEmbedded</code>.
    ...
    /**
    * Constructs a <code>ErrorEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ErrorEmbedded} obj Optional instance to populate.
    * @return {module:model/ErrorEmbedded} The populated <code>ErrorEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorEmbedded();
