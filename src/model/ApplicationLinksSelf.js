...
export default class ApplicationLinksSelf {
    /**
     * Constructs a new <code>ApplicationLinksSelf</code>.
    ...
    /**
    * Constructs a <code>ApplicationLinksSelf</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ApplicationLinksSelf} obj Optional instance to populate.
    * @return {module:model/ApplicationLinksSelf} The populated <code>ApplicationLinksSelf</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationLinksSelf();
