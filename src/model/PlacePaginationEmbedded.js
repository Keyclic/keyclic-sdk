...
/**
 * The PlacePaginationEmbedded model module.
 * @module model/PlacePaginationEmbedded
 * @version 1.12.1
 */
export default class PlacePaginationEmbedded {
    /**
     * Constructs a new <code>PlacePaginationEmbedded</code>.
     * 
     * @alias module:model/PlacePaginationEmbedded
     * @class
    ...
    /**
    * Constructs a <code>PlacePaginationEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PlacePaginationEmbedded} obj Optional instance to populate.
    * @return {module:model/PlacePaginationEmbedded} The populated <code>PlacePaginationEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlacePaginationEmbedded();

            


            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Place]);
            }
        }
        return obj;
    }
    ...
    /**
     * 
     * @member {Array.<module:model/Place>} items
     */
    items = undefined;
