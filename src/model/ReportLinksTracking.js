...
export default class ReportLinksTracking {
    /**
     * Constructs a new <code>ReportLinksTracking</code>.
    ...
    /**
    * Constructs a <code>ReportLinksTracking</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportLinksTracking} obj Optional instance to populate.
    * @return {module:model/ReportLinksTracking} The populated <code>ReportLinksTracking</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportLinksTracking();
    ...
    /**
     * The URI of the linked tracking.
     * @member {String} href
     */
    href = undefined;
    /**
