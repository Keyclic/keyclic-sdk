...
/**
 * The OperationBody model module.
 * @module model/OperationBody
 * @version 1.12.1
 */
export default class OperationBody {
    /**
     * Constructs a new <code>OperationBody</code>.
     * 
     * @alias module:model/OperationBody
     * @class
    ...
    /**
    * Constructs a <code>OperationBody</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationBody} obj Optional instance to populate.
    * @return {module:model/OperationBody} The populated <code>OperationBody</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationBody();
