...
/**
 * The AuthenticationSuccess model module.
 * @module model/AuthenticationSuccess
 * @version 1.12.1
 */
export default class AuthenticationSuccess {
    /**
     * Constructs a new <code>AuthenticationSuccess</code>.
     * 
     * @alias module:model/AuthenticationSuccess
     * @class
    ...
    /**
    * Constructs a <code>AuthenticationSuccess</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AuthenticationSuccess} obj Optional instance to populate.
    * @return {module:model/AuthenticationSuccess} The populated <code>AuthenticationSuccess</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthenticationSuccess();
            ...
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = ApiClient.convertToType(data['credentials'], [Credentials]);
            }
        }
        return obj;
    }
    ...
    tokenType = 'Bearer';
    /**
     * @member {Array.<module:model/Credentials>} credentials
     */
