...
export default class FeedbackLinks {
    /**
     * Constructs a new <code>FeedbackLinks</code>.
     * 
    ...
    /**
    * Constructs a <code>FeedbackLinks</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinks} obj Optional instance to populate.
    * @return {module:model/FeedbackLinks} The populated <code>FeedbackLinks</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinks();

            


            if (data.hasOwnProperty('self')) {
                obj['self'] = FeedbackLinksSelf.constructFromObject(data['self']);
            }
            if (data.hasOwnProperty('category')) {
                obj['category'] = FeedbackLinksCategory.constructFromObject(data['category']);
            }
            if (data.hasOwnProperty('image')) {
                obj['image'] = FeedbackLinksImage.constructFromObject(data['image']);
            }
            if (data.hasOwnProperty('reporter')) {
                obj['reporter'] = FeedbackLinksReporter.constructFromObject(data['reporter']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/FeedbackLinksSelf} self
     */
    self = undefined;
    /**
    ...
    category = undefined;
    /**
     * @member {module:model/FeedbackLinksImage} image
     */
    image = undefined;
    /**
     * @member {module:model/FeedbackLinksReporter} reporter
     */
    reporter = undefined;
