...
export default class OperationLinksReportIriTemplateMapping {
    /**
     * Constructs a new <code>OperationLinksReportIriTemplateMapping</code>.
    ...
    /**
    * Constructs a <code>OperationLinksReportIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationLinksReportIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/OperationLinksReportIriTemplateMapping} The populated <code>OperationLinksReportIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationLinksReportIriTemplateMapping();
