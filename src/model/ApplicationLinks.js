...
import ApplicationLinksIriTemplate from './ApplicationLinksIriTemplate';
...
export default class ApplicationLinks {
    /**
     * Constructs a new <code>ApplicationLinks</code>.
     * 
    ...
    /**
    * Constructs a <code>ApplicationLinks</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ApplicationLinks} obj Optional instance to populate.
    * @return {module:model/ApplicationLinks} The populated <code>ApplicationLinks</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationLinks();

            


            if (data.hasOwnProperty('self')) {
                obj['self'] = ApplicationLinksSelf.constructFromObject(data['self']);
            }
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = ApplicationLinksIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/ApplicationLinksSelf} self
     */
    self = undefined;
    /**
     * @member {module:model/ApplicationLinksIriTemplate} iriTemplate
     */
