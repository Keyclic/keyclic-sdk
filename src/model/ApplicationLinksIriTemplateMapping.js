...
/**
 * The ApplicationLinksIriTemplateMapping model module.
 * @module model/ApplicationLinksIriTemplateMapping
 * @version 1.12.1
 */
export default class ApplicationLinksIriTemplateMapping {
    /**
     * Constructs a new <code>ApplicationLinksIriTemplateMapping</code>.
     * @alias module:model/ApplicationLinksIriTemplateMapping
     * @class
    ...
    /**
    * Constructs a <code>ApplicationLinksIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ApplicationLinksIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/ApplicationLinksIriTemplateMapping} The populated <code>ApplicationLinksIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationLinksIriTemplateMapping();
