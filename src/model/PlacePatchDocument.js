...
/**
 * The PlacePatchDocument model module.
 * @module model/PlacePatchDocument
 * @version 1.12.1
 */
export default class PlacePatchDocument {
    /**
     * Constructs a new <code>PlacePatchDocument</code>.
     * @alias module:model/PlacePatchDocument
     * @class
    
     * @param op {module:model/PlacePatchDocument.OpEnum} The operation to be performed.
     * @param path {module:model/PlacePatchDocument.PathEnum} A JSON-Pointer.
     * @param value {String} 
     */
    constructor(
    op, 
    ...
    /**
    * Constructs a <code>PlacePatchDocument</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PlacePatchDocument} obj Optional instance to populate.
    * @return {module:model/PlacePatchDocument} The populated <code>PlacePatchDocument</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlacePatchDocument();
     ...
     * @member {module:model/PlacePatchDocument.OpEnum} op
     */
    op = undefined;
    /**
     * A JSON-Pointer.
     * @member {module:model/PlacePatchDocument.PathEnum} path
     */
    path = undefined;
    /**
     * 
