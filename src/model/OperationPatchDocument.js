...
/**
 * The OperationPatchDocument model module.
 * @module model/OperationPatchDocument
 * @version 1.12.1
 */
export default class OperationPatchDocument {
    /**
     * Constructs a new <code>OperationPatchDocument</code>.
     * @alias module:model/OperationPatchDocument
     * @class
    
     * @param op {module:model/OperationPatchDocument.OpEnum} The operation to be performed.
     * @param path {module:model/OperationPatchDocument.PathEnum} A JSON-Pointer.
     * @param value {String} 
     */
    constructor(
    op, 
    ...
    /**
    * Constructs a <code>OperationPatchDocument</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationPatchDocument} obj Optional instance to populate.
    * @return {module:model/OperationPatchDocument} The populated <code>OperationPatchDocument</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationPatchDocument();
     ...
     * @member {module:model/OperationPatchDocument.OpEnum} op
     */
    op = undefined;
    /**
     * A JSON-Pointer.
     * @member {module:model/OperationPatchDocument.PathEnum} path
     */
    path = undefined;
    /**
     * 
