...
export default class CategoryLinksSelfIriTemplate {
    /**
     * Constructs a new <code>CategoryLinksSelfIriTemplate</code>.
    ...
    /**
    * Constructs a <code>CategoryLinksSelfIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryLinksSelfIriTemplate} obj Optional instance to populate.
    * @return {module:model/CategoryLinksSelfIriTemplate} The populated <code>CategoryLinksSelfIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryLinksSelfIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = CategoryLinksSelfIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/CategoryLinksSelfIriTemplateMapping} mapping
     */
    mapping = undefined;
