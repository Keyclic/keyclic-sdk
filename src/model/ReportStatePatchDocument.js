...
/**
 * The ReportStatePatchDocument model module.
 * @module model/ReportStatePatchDocument
 * @version 1.12.1
 */
export default class ReportStatePatchDocument {
    /**
     * Constructs a new <code>ReportStatePatchDocument</code>.
     * @alias module:model/ReportStatePatchDocument
     * @class
    
     * @param op {module:model/ReportStatePatchDocument.OpEnum} The operation to be performed.
     * @param path {String} A JSON-Pointer.
     * @param value {module:model/ReportStatePatchDocument.ValueEnum} 
     */
    constructor(
    op, 
    path, 
    ...
    /**
    * Constructs a <code>ReportStatePatchDocument</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportStatePatchDocument} obj Optional instance to populate.
    * @return {module:model/ReportStatePatchDocument} The populated <code>ReportStatePatchDocument</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportStatePatchDocument();
     ...
     * @member {module:model/ReportStatePatchDocument.OpEnum} op
     */
    op = undefined;
    /**
     * A JSON-Pointer.
    ...
    /**
     * 
     * @member {module:model/ReportStatePatchDocument.ValueEnum} value
     */
    value = undefined;
