...
/**
 * The OperationPaginationEmbedded model module.
 * @module model/OperationPaginationEmbedded
 * @version 1.12.1
 */
export default class OperationPaginationEmbedded {
    /**
     * Constructs a new <code>OperationPaginationEmbedded</code>.
     * 
     * @alias module:model/OperationPaginationEmbedded
     * @class
    ...
    /**
    * Constructs a <code>OperationPaginationEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationPaginationEmbedded} obj Optional instance to populate.
    * @return {module:model/OperationPaginationEmbedded} The populated <code>OperationPaginationEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationPaginationEmbedded();
    ...
    /**
     * 
     * @member {Array.<module:model/Operation>} items
     */
    items = undefined;
