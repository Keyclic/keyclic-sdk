...
export default class FeedbackLinksReporter {
    /**
     * Constructs a new <code>FeedbackLinksReporter</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksReporter</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksReporter} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksReporter} The populated <code>FeedbackLinksReporter</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksReporter();
            ...
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = FeedbackLinksReporterIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * The URI of the linked person.
     * @member {String} href
     */
    href = undefined;
    /**
     * @member {module:model/FeedbackLinksReporterIriTemplate} iriTemplate
     */
