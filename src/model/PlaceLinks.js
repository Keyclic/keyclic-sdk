...
export default class PlaceLinks {
    /**
     * Constructs a new <code>PlaceLinks</code>.
     * 
    ...
    /**
    * Constructs a <code>PlaceLinks</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PlaceLinks} obj Optional instance to populate.
    * @return {module:model/PlaceLinks} The populated <code>PlaceLinks</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaceLinks();

            


            if (data.hasOwnProperty('self')) {
                obj['self'] = PlaceLinksSelf.constructFromObject(data['self']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/PlaceLinksSelf} self
     */
    self = undefined;
