...
import CategoryLinksIriTemplate from './CategoryLinksIriTemplate';
...
export default class CategoryLinksOrganization {
    /**
     * Constructs a new <code>CategoryLinksOrganization</code>.
    ...
    /**
    * Constructs a <code>CategoryLinksOrganization</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryLinksOrganization} obj Optional instance to populate.
    * @return {module:model/CategoryLinksOrganization} The populated <code>CategoryLinksOrganization</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryLinksOrganization();
            ...
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = CategoryLinksIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * The URI of the linked organization.
     * @member {String} href
     */
    href = undefined;
    /**
     * @member {module:model/CategoryLinksIriTemplate} iriTemplate
     */
