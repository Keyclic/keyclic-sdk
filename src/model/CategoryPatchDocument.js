...
/**
 * The CategoryPatchDocument model module.
 * @module model/CategoryPatchDocument
 * @version 1.12.1
 */
export default class CategoryPatchDocument {
    /**
     * Constructs a new <code>CategoryPatchDocument</code>.
     * @alias module:model/CategoryPatchDocument
     * @class
    
     * @param op {module:model/CategoryPatchDocument.OpEnum} The operation to be performed.
     * @param path {module:model/CategoryPatchDocument.PathEnum} A JSON-Pointer.
     * @param value {String} 
     */
    constructor(
    op, 
    ...
    /**
    * Constructs a <code>CategoryPatchDocument</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryPatchDocument} obj Optional instance to populate.
    * @return {module:model/CategoryPatchDocument} The populated <code>CategoryPatchDocument</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryPatchDocument();
     ...
     * @member {module:model/CategoryPatchDocument.OpEnum} op
     */
    op = undefined;
    /**
     * A JSON-Pointer.
     * @member {module:model/CategoryPatchDocument.PathEnum} path
     */
    path = undefined;
    /**
     * 
