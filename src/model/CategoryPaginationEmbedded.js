...
/**
 * The CategoryPaginationEmbedded model module.
 * @module model/CategoryPaginationEmbedded
 * @version 1.12.1
 */
export default class CategoryPaginationEmbedded {
    /**
     * Constructs a new <code>CategoryPaginationEmbedded</code>.
     * 
     * @alias module:model/CategoryPaginationEmbedded
     * @class
    ...
    /**
    * Constructs a <code>CategoryPaginationEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryPaginationEmbedded} obj Optional instance to populate.
    * @return {module:model/CategoryPaginationEmbedded} The populated <code>CategoryPaginationEmbedded</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryPaginationEmbedded();
