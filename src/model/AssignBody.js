...
/**
 * The AssignBody model module.
 * @module model/AssignBody
 * @version 1.12.1
 */
export default class AssignBody {
    /**
     * Constructs a new <code>AssignBody</code>.
     * @alias module:model/AssignBody
     * @class
    ...
    /**
    * Constructs a <code>AssignBody</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AssignBody} obj Optional instance to populate.
    * @return {module:model/AssignBody} The populated <code>AssignBody</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssignBody();
    ...
    /**
     * The GUID of the person assigned to the given operation.
