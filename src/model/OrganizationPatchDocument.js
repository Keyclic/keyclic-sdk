...
/**
 * The OrganizationPatchDocument model module.
 * @module model/OrganizationPatchDocument
 * @version 1.12.1
 */
export default class OrganizationPatchDocument {
    /**
     * Constructs a new <code>OrganizationPatchDocument</code>.
     * @alias module:model/OrganizationPatchDocument
     * @class
    
     * @param op {module:model/OrganizationPatchDocument.OpEnum} The operation to be performed.
     * @param path {module:model/OrganizationPatchDocument.PathEnum} A JSON-Pointer.
     * @param value {String} 
     */
    constructor(
    op, 
    ...
    /**
    * Constructs a <code>OrganizationPatchDocument</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrganizationPatchDocument} obj Optional instance to populate.
    * @return {module:model/OrganizationPatchDocument} The populated <code>OrganizationPatchDocument</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationPatchDocument();
     ...
     * @member {module:model/OrganizationPatchDocument.OpEnum} op
     */
    op = undefined;
    /**
     * A JSON-Pointer.
     * @member {module:model/OrganizationPatchDocument.PathEnum} path
     */
    path = undefined;
    /**
     * 
