...
export default class OperationLinksSelfIriTemplate {
    /**
     * Constructs a new <code>OperationLinksSelfIriTemplate</code>.
    ...
    /**
    * Constructs a <code>OperationLinksSelfIriTemplate</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationLinksSelfIriTemplate} obj Optional instance to populate.
    * @return {module:model/OperationLinksSelfIriTemplate} The populated <code>OperationLinksSelfIriTemplate</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationLinksSelfIriTemplate();

            


            if (data.hasOwnProperty('mapping')) {
                obj['mapping'] = OperationLinksSelfIriTemplateMapping.constructFromObject(data['mapping']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/OperationLinksSelfIriTemplateMapping} mapping
     */
    mapping = undefined;
