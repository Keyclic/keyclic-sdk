...
export default class OrganizationLinksLogo {
    /**
     * Constructs a new <code>OrganizationLinksLogo</code>.
    ...
    /**
    * Constructs a <code>OrganizationLinksLogo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrganizationLinksLogo} obj Optional instance to populate.
    * @return {module:model/OrganizationLinksLogo} The populated <code>OrganizationLinksLogo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationLinksLogo();
