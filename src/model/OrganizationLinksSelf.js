...
export default class OrganizationLinksSelf {
    /**
     * Constructs a new <code>OrganizationLinksSelf</code>.
    ...
    /**
    * Constructs a <code>OrganizationLinksSelf</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrganizationLinksSelf} obj Optional instance to populate.
    * @return {module:model/OrganizationLinksSelf} The populated <code>OrganizationLinksSelf</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationLinksSelf();
