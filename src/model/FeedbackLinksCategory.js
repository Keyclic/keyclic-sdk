...
export default class FeedbackLinksCategory {
    /**
     * Constructs a new <code>FeedbackLinksCategory</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksCategory</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksCategory} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksCategory} The populated <code>FeedbackLinksCategory</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksCategory();
    ...
    /**
     * The URI of the linked category.
     * @member {String} href
     */
    href = undefined;
    /**
