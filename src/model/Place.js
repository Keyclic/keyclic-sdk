...
export default class Place {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_links')) {
                obj['_links'] = PlaceLinks.constructFromObject(data['_links']);
            }
        }
        return obj;
    }
    ...
    /**
     * The type of the resource according to schema.org: https://schema.org/Place.
     * @member {String} type
     * @default 'Place'
     */
    type = 'Place';
    /**
     * The uuid of the place
     * @member {String} id
     */
    id = undefined;
    /**
    ...
    name = '';
    /**
     * @member {module:model/PlaceLinks} _links
     */
    _links = undefined;
