...
export default class FeedbackLinksSelfIriTemplateMapping {
    /**
     * Constructs a new <code>FeedbackLinksSelfIriTemplateMapping</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksSelfIriTemplateMapping</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksSelfIriTemplateMapping} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksSelfIriTemplateMapping} The populated <code>FeedbackLinksSelfIriTemplateMapping</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksSelfIriTemplateMapping();
