...
export default class FeedbackLinksSelf {
    /**
     * Constructs a new <code>FeedbackLinksSelf</code>.
    ...
    /**
    * Constructs a <code>FeedbackLinksSelf</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackLinksSelf} obj Optional instance to populate.
    * @return {module:model/FeedbackLinksSelf} The populated <code>FeedbackLinksSelf</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackLinksSelf();
    ...
    /**
     * The URI of the current feedback.
     * @member {String} href
     */
    href = undefined;
    /**
