...
export default class PlaceLinksSelf {
    /**
     * Constructs a new <code>PlaceLinksSelf</code>.
    ...
    /**
    * Constructs a <code>PlaceLinksSelf</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PlaceLinksSelf} obj Optional instance to populate.
    * @return {module:model/PlaceLinksSelf} The populated <code>PlaceLinksSelf</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaceLinksSelf();
            ...
            if (data.hasOwnProperty('iriTemplate')) {
                obj['iriTemplate'] = PlaceLinksSelfIriTemplate.constructFromObject(data['iriTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * The URI of the current place.
     * @member {String} href
     */
    href = undefined;
    /**
     * @member {module:model/PlaceLinksSelfIriTemplate} iriTemplate
     */
