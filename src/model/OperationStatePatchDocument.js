...
/**
 * The OperationStatePatchDocument model module.
 * @module model/OperationStatePatchDocument
 * @version 1.12.1
 */
export default class OperationStatePatchDocument {
    /**
     * Constructs a new <code>OperationStatePatchDocument</code>.
     * @alias module:model/OperationStatePatchDocument
     * @class
    
     * @param op {module:model/OperationStatePatchDocument.OpEnum} The operation to be performed.
     * @param path {String} A JSON-Pointer.
     * @param value {module:model/OperationStatePatchDocument.ValueEnum} 
     */
    constructor(
    op, 
    path, 
    ...
    /**
    * Constructs a <code>OperationStatePatchDocument</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OperationStatePatchDocument} obj Optional instance to populate.
    * @return {module:model/OperationStatePatchDocument} The populated <code>OperationStatePatchDocument</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationStatePatchDocument();
     ...
     * @member {module:model/OperationStatePatchDocument.OpEnum} op
     */
    op = undefined;
    /**
     * A JSON-Pointer.
    ...
    /**
     * 
     * @member {module:model/OperationStatePatchDocument.ValueEnum} value
     */
    value = undefined;
