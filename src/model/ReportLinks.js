...
export default class ReportLinks {
    /**
     * Constructs a new <code>ReportLinks</code>.
     * 
    ...
    /**
    * Constructs a <code>ReportLinks</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReportLinks} obj Optional instance to populate.
    * @return {module:model/ReportLinks} The populated <code>ReportLinks</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportLinks();

            


            if (data.hasOwnProperty('self')) {
                obj['self'] = ReportLinksSelf.constructFromObject(data['self']);
            }
            if (data.hasOwnProperty('category')) {
                obj['category'] = FeedbackLinksCategory.constructFromObject(data['category']);
            }
            if (data.hasOwnProperty('feedback')) {
                obj['feedback'] = ReportLinksFeedback.constructFromObject(data['feedback']);
            }
            if (data.hasOwnProperty('operations')) {
                obj['operations'] = ReportLinksOperations.constructFromObject(data['operations']);
            }
            if (data.hasOwnProperty('organization')) {
                obj['organization'] = CategoryLinksOrganization.constructFromObject(data['organization']);
            }
            if (data.hasOwnProperty('tracking')) {
                obj['tracking'] = ReportLinksTracking.constructFromObject(data['tracking']);
            }
        }
        return obj;
    }
    ...
    /**
     * @member {module:model/ReportLinksSelf} self
     */
    self = undefined;
    /**
     * @member {module:model/FeedbackLinksCategory} category
     */
    category = undefined;
    /**
     * @member {module:model/ReportLinksFeedback} feedback
     */
    feedback = undefined;
    /**
     * @member {module:model/ReportLinksOperations} operations
     */
    operations = undefined;
    /**
     * @member {module:model/CategoryLinksOrganization} organization
     */
    organization = undefined;
    /**
     * @member {module:model/ReportLinksTracking} tracking
     */
    tracking = undefined;
