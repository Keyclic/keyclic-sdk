...
import FeedbackPaginationEmbedded from './FeedbackPaginationEmbedded';
 ...
 * @version 1.12.1
 */
export default class FeedbackPagination {
    /**
     * Constructs a new <code>FeedbackPagination</code>.
     * A list of feedbacks formatted as HATEOAS paginated representation.
    ...
    /**
    * Constructs a <code>FeedbackPagination</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FeedbackPagination} obj Optional instance to populate.
    * @return {module:model/FeedbackPagination} The populated <code>FeedbackPagination</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeedbackPagination();
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = FeedbackPaginationEmbedded.constructFromObject(data['_embedded']);
            }
        }
        return obj;
    }
    ...
    _links = undefined;
    /**
     * @member {module:model/FeedbackPaginationEmbedded} _embedded
     */
    _embedded = undefined;
